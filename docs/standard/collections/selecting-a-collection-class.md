...
ms.topic: "article"
helpviewer_keywords: 
  - "collections (.NET Framework), sélectionner une classe de collection"
  - "classes de collections"
  - "collections premier entré premier sorti"
  - "regrouper des données dans des collections, sélectionner une classe de collection"
  - "collections indexées"
  - "collections dernier entré dernier sorti"
