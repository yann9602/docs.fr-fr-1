---
title: "Comment&#160;: ajouter ou supprimer des entr&#233;es dans la liste de contr&#244;le d&#39;acc&#232;s | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "entrées de contrôle d'accès (.NET Framework)"
  - "listes de contrôle d'accès (.NET Framework)"
  - "ACE (.NET Framework)"
  - "ACL (.NET Framework)"
  - "E/S (.NET Framework), entrées de liste de contrôle d'accès"
...
### Pour ajouter ou supprimer une entrée ACL dans un fichier  
...
### Pour ajouter ou supprimer une entrée ACL dans un répertoire  
