---
title: "Gestion et lev&#233;e des exceptions | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
helpviewer_keywords: 
  ...
  - "erreurs (.NET Framework), exceptions"
  - "exceptions (.NET Framework)"
  - "exceptions (.NET Framework), gérer"
  - "exceptions (.NET Framework), lever"
  - "filtrer des exceptions"
  - "runtime, exceptions"
...
## Filtrage des exceptions du runtime  
...
|[How to: Map HRESULTs and Exceptions](../../../docs/framework/interop/how-to-map-hresults-and-exceptions.md)|Décrit le mappage des exceptions entre le code managé et le code non managé.|  
