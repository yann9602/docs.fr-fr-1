...
[Précédent] (../multi-container-microservice-net-applications/background-tasks-with-ihostedservice.md) [Suivant] (apply-simplified-microservice-cqrs-ddd-patterns.md)
