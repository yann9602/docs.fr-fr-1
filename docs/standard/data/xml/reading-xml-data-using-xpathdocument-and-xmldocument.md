---
title: "Lecture de donn&#233;es XML &#224; l&#39;aide de XPathDocument et XmlDocument | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
Il existe deux manières de lire un document XML dans l'espace de noms <xref:System.Xml.XPath?displayProperty=fullName>.  La première consiste à lire un document XML à l'aide de la classe <xref:System.Xml.XPath.XPathDocument> en lecture seule et la seconde à lire un document XML à l'aide de la classe <xref:System.Xml.XmlDocument> modifiable dans l'espace de noms <xref:System.Xml?displayProperty=fullName>.  
...
## Lecture de documents XML à l'aide de la classe XPathDocument  
 ...
 L'exemple suivant illustre l'utilisation du constructeur `string` de la classe <xref:System.Xml.XPath.XPathDocument> en vue de la lecture d'un document XML.  
...
## Création d'objet XPathNavigator  
 ...
 Les classes <xref:System.Xml.XPath.XPathDocument> et <xref:System.Xml.XmlDocument>, en plus de la classe <xref:System.Xml.XmlNode>, implémentent l'interface <xref:System.Xml.XPath.IXPathNavigable> de l'espace de noms <xref:System.Xml.XPath?displayProperty=fullName>.  Par conséquent, ces trois classes fournissent une méthode <xref:System.Xml.XPath.IXPathNavigable.CreateNavigator%2A> qui retourne un objet <xref:System.Xml.XPath.XPathNavigator>.  
