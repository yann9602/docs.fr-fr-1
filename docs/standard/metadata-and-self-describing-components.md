---
title: "M&#233;tadonn&#233;es et composants autodescriptifs | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "Common Language Runtime, métadonnées"
  - "composants (.NET Framework), métadonnées"
  - "langages, interopérabilité"
  - "métadonnées, à propos des métadonnées"
  - "fichiers PE, métadonnées"
  - "fichiers exécutables portables, métadonnées"
  - "runtime, métadonnées"
