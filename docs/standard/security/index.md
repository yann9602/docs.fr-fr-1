---
title: "Sécurité dans le .NET Framework | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
ms.prod: .net
ms.reviewer: 
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit certaines des meilleures pratiques pour la création d'applications .NET Framework fiables. Cette section s'adresse aux développeurs.  
