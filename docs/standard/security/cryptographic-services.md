---
title: "Services de chiffrement | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
dev_langs: 
  ...
  - "jsharp"
helpviewer_keywords: 
  - "chiffrement (.NET Framework)"
  - "modèle d’héritage de classe dérivée"
  - "signatures numériques"
  - "algorithmes de chiffrement asymétriques"
  - "signatures numériques, systèmes de clés publiques"
  - "clés publiques"
  - "déchiffrement (.NET Framework)"
  - "clés privées"
  - "algorithmes MAC"
  - "algorithmes de chiffrement"
  - "clés privées, vue d’ensemble"
  - "chiffrement (.NET Framework)"
  ...
  - "chiffrement (.NET Framework), présentation"
...
-   [Signatures numériques](#digital_signatures)  
  
-   [Valeurs de hachage](#hash_values)  
  
-   [Génération de nombres aléatoires](#random_numbers)  
...
## Manifestes ClickOnce  
 Dans le [!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)], les classes de chiffrement suivantes vous permettent d'obtenir et de vérifier les informations sur les signatures de manifeste des applications déployées à l'aide de la [technologie ClickOnce](../Topic/ClickOnce%20Security%20and%20Deployment.md) :  
...
## Prise en charge de Suite B  
 Le [!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)] prend en charge le jeu d'algorithmes de chiffrement Suite B publié par la NSA \(National Security Agency\). Pour plus d’informations sur Suite B, consultez le [descriptif de la NSA sur le chiffrement Suite B](http://go.microsoft.com/fwlink/?LinkId=100111).  
