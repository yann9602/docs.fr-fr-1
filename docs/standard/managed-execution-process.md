---
title: "Processus d&#39;ex&#233;cution manag&#233;e | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
helpviewer_keywords: 
  - "code source (langage)"
  - "code, processus d’exécution managée"
  - "runtime, processus d’exécution managée"
  - "compilation du code source, processus d’exécution managée"
  - "processus d'exécution managée"
  - "common language runtime, processus d’exécution managée"
...
-   À l’aide de l’outil [Ngen.exe \(Native Image Generator\)](../../docs/framework/tools/ngen-exe-native-image-generator.md) du .NET Framework  
