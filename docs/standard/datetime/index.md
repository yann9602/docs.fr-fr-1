...
Outre la structure <xref:System.DateTime> élémentaire, le [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] fournit les classes suivantes qui prennent en charge l’utilisation des fuseaux horaires :  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Explique comment instancier un objet <xref:System.TimeZoneInfo> à partir du Registre du système local.  
