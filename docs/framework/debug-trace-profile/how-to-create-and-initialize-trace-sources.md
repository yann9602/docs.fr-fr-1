---
title: "Guide pratique pour créer et initialiser les sources de trace"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="how-to-create-and-initialize-trace-sources"></a>Guide pratique pour créer et initialiser les sources de trace
...
3.  Remplacez le contenu du fichier de configuration par défaut par les paramètres suivants pour initialiser un écouteur de suivi de console et un écouteur de suivi de TextWriter pour la source de trace créée à l'étape 1.  
    ...
    ```  
     ...
     La modification des paramètres du fichier de configuration lorsque l'application est en cours d'exécution ne change pas les paramètres d'origine. Pour modifier les paramètres, vous devez redémarrer l'application ou l'actualiser par programmation à l'aide de la méthode <xref:System.Diagnostics.Trace.Refresh%2A?displayProperty=fullName>.  
