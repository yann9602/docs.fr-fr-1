---
title: "Comment&#160;: cr&#233;er une pr&#233;sentation Windows Forms qui r&#233;pond bien &#224; la localisation | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "conception d'applications, localisation"
  - "localisation, Windows Forms (présentation)"
  - "TableLayoutPanel (contrôle Windows Forms)"
  - "Windows Forms, localisation"
...
2.  [Procédure pas à pas : organisation des contrôles dans les Windows Forms à l'aide d'un FlowLayoutPanel](http://msdn.microsoft.com/library/z9w7ek2f%20\(v=vs.110\))  
...
5.  [Procédure pas à pas : exécution de tâches courantes à l'aide de balises actives sur Windows Forms contrôles](http://msdn.microsoft.com/library/xhz359sc\(v=vs.110\))  
  
6.  [Procédure pas à pas : disposition des contrôles dans les Windows Forms à l'aide d'un TableLayoutPanel](http://msdn.microsoft.com/library/w4yc3e8c\(v=vs.110\))  
  
7.  [Procédure pas à pas : disposition des contrôles Windows Forms avec les propriétés Padding, Margins et AutoSize](http://msdn.microsoft.com/library/3z3f9e8b%20\(v=vs.110\))  
...
9. [Procédure pas à pas : création un Windows Form redimensionnable pour l'entrée de données](http://msdn.microsoft.com/library/991eahec%20\(v=vs.110\))  
