---
title: "ToolStripPanel, contr&#244;le | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  - "espace horizontal"
  - "zone d'outils (Windows Forms)"
  - "ToolStrip (contrôle Windows Forms), ToolStripPanel"
...
## Dans cette section  
 [Vue d'ensemble du contrôle ToolStripPanel](../../../../docs/framework/winforms/controls/toolstrippanel-control-overview.md)  
 ...
 [Comment : utiliser des contrôles ToolStripPanel pour MDI](../../../../docs/framework/winforms/controls/how-to-use-toolstrippanels-for-mdi.md)  
