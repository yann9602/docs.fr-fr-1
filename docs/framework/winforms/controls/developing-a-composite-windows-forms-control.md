...
-   [Guide pratique pour afficher un contrôle dans la boîte de dialogue Choisir des éléments de boîte à outils](http://msdn.microsoft.com/library/9yxtkx75\(v=vs.110\))  
...
-   [Guide pratique pour fournir une bitmap pour un contrôle en vue de l’afficher dans la boîte à outils](http://msdn.microsoft.com/library/4wk1wc0a\(v=vs.110\))  
