...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour activer l'affichage en mosaïque dans un contrôle ListView Windows Forms](../../../../docs/framework/winforms/controls/how-to-enable-tile-view-in-a-windows-forms-listview-control.md)  
