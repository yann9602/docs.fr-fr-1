---
title: "Comment&#160;: d&#233;finir le convertisseur ToolStrip au moment de l&#39;ex&#233;cution | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "ToolStripManager (classe Windows Forms)"
...
## Affectation d'un convertisseur personnalisé  
 Créez un `ToolStripProfessionalRenderer` avec une classe `CustomProfessionalColors` et assignez\-le à la propriété <xref:System.Windows.Forms.ToolStripManager.Renderer%2A?displayProperty=fullName>.  
