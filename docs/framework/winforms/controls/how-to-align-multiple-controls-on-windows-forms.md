...
### <a name="to-align-multiple-controls-on-a-form"></a>Pour aligner plusieurs contrôles dans un formulaire  
  
1.  Ouvrez le formulaire contenant les contrôles que vous souhaitez inclure dans le **Concepteur Windows Forms**.  
  
2.  Sélectionnez les contrôles que vous souhaitez aligner afin que le premier contrôle que vous sélectionnez est le contrôle primaire à laquelle les autres doivent être alignées.  
  
3.  Sur le **Format** menu, pointez sur **Align**, puis cliquez sur une des sept options proposées.  
