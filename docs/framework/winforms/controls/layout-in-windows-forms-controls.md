...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit la <xref:System.Windows.Forms.Control.Margin%2A> et <xref:System.Windows.Forms.Control.Padding%2A> propriétés et leurs rôles dans la disposition.  
 ...
 [Guide pratique pour créer une bordure autour d'un contrôle Windows Form à l'aide du remplissage](../../../../docs/framework/winforms/controls/how-to-create-a-border-around-a-windows-forms-control-using-padding.md)  
 Montre comment utiliser le <xref:System.Windows.Forms.Control.Padding%2A> propriété pour encadrer un contrôle.  
  
 [Guide pratique pour implémenter un moteur de présentation personnalisé](../../../../docs/framework/winforms/controls/how-to-implement-a-custom-layout-engine.md)  
...
## <a name="reference"></a>Référence  
 ...
 Fournit la documentation de référence pour le contrôle <xref:System.Windows.Forms.TableLayoutPanel>.  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Comportement du redimensionnement automatique dans le contrôle TableLayoutPanel](../../../../docs/framework/winforms/controls/autosize-behavior-in-the-tablelayoutpanel-control.md)
