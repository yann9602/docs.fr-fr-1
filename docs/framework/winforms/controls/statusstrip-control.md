...
## <a name="in-this-section"></a>Dans cette section  
 [Vue d’ensemble du contrôle StatusStrip](../../../../docs/framework/winforms/controls/statusstrip-control-overview.md)  
 ...
 Consultez également [éditeur de collections d’éléments StatusStrip](http://msdn.microsoft.com/library/ms233631\(v=vs.110\)), [éditeur de collections d’éléments StatusStrip](http://msdn.microsoft.com/library/ms233642\(v=vs.110\)).  
