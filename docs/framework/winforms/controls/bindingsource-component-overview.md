---
title: "Vue d&#39;ensemble du composant BindingSource | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "contrôles (Windows Forms), lier aux données"
...
## Composant BindingSource comme intermédiaire  
 ...
 ![Source de liaison et architecture de liaison de données](../../../../docs/framework/winforms/controls/media/net-bindsrcdatabindarch.gif "NET\_BindSrcDataBindArch")  
  
> [!NOTE]
>  Au moment du design, certaines actions \(comme le déplacement d'une table de base de données d'une fenêtre de données vers un nouveau formulaire\) créent le composant <xref:System.Windows.Forms.BindingSource>, le lient à la source de données sous\-jacente et ajoutent des contrôles de données en une seule opération.  Consultez également [Liaison de contrôles Windows Forms à des données dans Visual Studio](../Topic/Bind%20Windows%20Forms%20controls%20to%20data%20in%20Visual%20Studio.md).  
