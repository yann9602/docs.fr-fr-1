---
title: "TableLayoutPanel, contr&#244;le (Windows Forms) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
4.  [Procédure pas à pas : disposition des contrôles dans les Windows Forms à l'aide d'un TableLayoutPanel](http://msdn.microsoft.com/library/w4yc3e8c\(v=vs.110\))  
...
## Rubriques connexes  
 ...
 Voir également [Localisation d'applications](http://msdn.microsoft.com/library/z68135h5\(v=vs.110\)) ou [Localisation d'applications](http://msdn.microsoft.com/library/z68135h5\(v=vs.120\))