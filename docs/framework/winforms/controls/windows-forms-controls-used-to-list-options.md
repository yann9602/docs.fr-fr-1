...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Recommande d’un contrôle de liste approprié selon les besoins et les restrictions de votre Windows Form.  
 ...
 Explique comment déterminer par programme quel élément dans une liste apparaît dans une position donnée.  
 ...
 Explique comment trier les données de liste à la source de données.  
