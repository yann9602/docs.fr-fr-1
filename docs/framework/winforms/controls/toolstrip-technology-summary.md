---
title: "R&#233;sum&#233; de la technologie ToolStrip | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "menus (Windows Forms), résumé de technologie"
  - "barres d'état, résumé de technologie"
  - "barres d'outils (Windows Forms), résumé de technologie"
  - "ToolStrip (contrôle Windows Forms), résumé de technologie"
...
### Éditeurs de collections Items  
 Dans Visual Studio, quand vous cliquez sur **Modifier les éléments** dans la liste de tâches ou quand vous cliquez avec le bouton droit sur le contrôle, puis sélectionnez **Modifier les éléments** dans le menu contextuel, l'éditeur de collections du contrôle s'affiche.  Les éditeurs de collections vous permettent d'ajouter, de supprimer et de réorganiser les éléments que contient le contrôle.  Vous pouvez également afficher et modifier les propriétés du contrôle et de ses éléments.  
...
## Hébergement des contrôles  
 ...
 Pour obtenir un exemple d'hébergement de contrôles, consultez [Comment : inclure un contrôle Windows Forms dans un wrapper avec ToolStripControlHost](../../../../docs/framework/winforms/controls/how-to-wrap-a-windows-forms-control-with-toolstripcontrolhost.md).  
...
## Rafting et ancrage  
 ...
 Le *rafting* correspond à la capacité des barres d'outils de partager l'espace horizontal ou vertical.  Un formulaire Windows peut avoir un <xref:System.Windows.Forms.ToolStripContainer> qui contient des panneaux gauche, droit, haut et bas pour le positionnement, ainsi que les contrôles <xref:System.Windows.Forms.ToolStrip>, <xref:System.Windows.Forms.MenuStrip> et <xref:System.Windows.Forms.StatusStrip> pour le rafting.  Plusieurs contrôles <xref:System.Windows.Forms.ToolStrip> s'empilent verticalement si vous les placez dans le <xref:System.Windows.Forms.ToolStripContainer> de gauche ou de droite.  Ils s'empilent horizontalement si vous les placez dans le <xref:System.Windows.Forms.ToolStripContainer> du haut ou du bas.  Vous pouvez utiliser le <xref:System.Windows.Forms.ToolStripContentPanel> central du <xref:System.Windows.Forms.ToolStripContainer> pour positionner les contrôles traditionnels sur le formulaire.  
 ...
 L'*ancrage* consiste à spécifier l'emplacement d'un contrôle, c'est\-à\-dire, à gauche, à droite, en haut ou au bas du formulaire.  
