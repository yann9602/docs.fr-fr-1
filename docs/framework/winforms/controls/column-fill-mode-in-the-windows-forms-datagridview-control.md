---
title: "Mode Remplissage des colonnes dans le contr&#244;le DataGridView Windows Forms | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "grilles de données, redimensionner automatiquement des colonnes"
  - "grilles de données, remplissage des colonnes (mode)"
  - "DataGridView (contrôle Windows Forms), remplissage des colonnes (mode)"
...
## Réglage de FillWeight basé sur le contenu  
