...
> [!NOTE]
>  Les contrôles [!INCLUDE[vbprvb](../../../../includes/vbprvb-md.md)] sont basés sur les classes fournies par le [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)].  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 FileDialog, classe  
 Fournit les fonctionnalités de la classe de base pour les boîtes de dialogue de fichiers.  
