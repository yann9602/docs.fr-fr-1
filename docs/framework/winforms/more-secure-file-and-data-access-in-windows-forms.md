---
title: "Acc&#232;s plus s&#233;curis&#233; aux fichiers et aux donn&#233;es dans les Windows Forms | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "données (Windows Forms), accès sécurisé"
  - "accès aux données (Windows Forms)"
  - "accès à la base de données (sécurité Windows Forms)"
  - "accès aux fichiers (Windows Forms)"
  - "registre (Windows Forms)"
  - "sécurité (Windows Forms), accès aux données"
  - "sécurité (Windows Forms), accès au fichier"
...
> [!NOTE]
>  Par défaut, les outils qui génèrent des déploiements [!INCLUDE[ndptecclick](../../../includes/ndptecclick-md.md)] font en sorte que ces déploiements demandent par défaut une confiance totale aux ordinateurs sur lesquels ils s'exécutent.  Si vous souhaitez bénéficier des avantages de sécurité supplémentaires offerts par l'exécution avec confiance partielle, vous devez modifier ce comportement par défaut dans [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] ou dans l'un des outils du [!INCLUDE[winsdklong](../../../includes/winsdklong-md.md)] \(Mage.exe ou MageUI.exe\).  Pour plus d'informations sur la sécurité des Windows Forms et sur la façon de déterminer le niveau de confiance approprié pour votre application, consultez [Vue d'ensemble de la sécurité dans les Windows Forms](../../../docs/framework/winforms/security-in-windows-forms-overview.md).  
