...
## <a name="in-this-section"></a>Dans cette section  
 [Coordonnées Windows Forms](../../../docs/framework/winforms/windows-forms-coordinates.md).  
 Décrit les coordonnées clientes et d'écran.  
  
 [Guide pratique pour créer une application Windows Forms à partir de la ligne de commande](../../../docs/framework/winforms/how-to-create-a-windows-forms-application-from-the-command-line.md)  
