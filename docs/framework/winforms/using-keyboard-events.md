---
title: "Utilisation des &#233;v&#233;nements du clavier | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "claviers, événements de clavier"
  - "KeyDown (événement)"
  - "KeyPress (événement)"
  - "KeyUp (événement)"
...
-   L'événement <xref:System.Windows.Forms.Control.KeyUp> se produit une fois quand l'utilisateur relâche une touche.  
 ...
 Quand l'utilisateur appuie sur une touche, Windows Forms détermine quel événement déclencher selon que le message de clavier spécifie une touche de caractère ou une touche physique.  Pour plus d'informations sur les touches de caractères et les touches physiques, consultez [Fonctionnement de l'entrée au clavier](../../../docs/framework/winforms/how-keyboard-input-works.md).  
