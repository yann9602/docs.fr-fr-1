...
---
# <a name="adjusting-the-size-and-scale-of-windows-forms"></a>Ajustement de la taille et l’échelle des Windows Forms
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Prise en charge des résolutions élevées dans les Windows Forms](../../../docs/framework/winforms/high-dpi-support-in-windows-forms.md)    
 Décrit la prise en charge de Windows Forms pour la mise à l’échelle dynamique et la haute résolution. 
