...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment effectuer des tâches de base avec [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)].  
 ...
 Montre comment construire un stylet et l’utiliser pour dessiner une variété de formes et de lignes.  
  
 [Utilisation d'un pinceau pour remplir des formes](../../../../docs/framework/winforms/advanced/using-a-brush-to-fill-shapes.md)  
 Montre comment construire un pinceau et remplir des formes avec différents effets.  
 ...
 Montre comment obtenir la transparence des formes et des lignes.  
 ...
 Montre les transformations de matrices.  
  
 [Utilisation de conteneurs graphiques](../../../../docs/framework/winforms/advanced/using-graphics-containers.md)  
 Montre comment gérer des conteneurs graphiques imbriqués et l’état objet graphiques.  
 ...
 Présente les divers aspects de la manipulation des couleurs.  
 ...
 Afficher l’utilisation des encodeurs d’image et de décodeurs pour manipuler des images.  
  
 [Graphiques mis deux fois en mémoire tampon](../../../../docs/framework/winforms/advanced/double-buffered-graphics.md)  
 Montre comment réduire le scintillement des doubles tampons.
