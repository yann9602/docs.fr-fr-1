...
|-----------------------------------------|------------|  
|Fournisseur de runtime `JITKeyword` \(0x10\)|Informatif \(4\)|  
|Fournisseur de runtime `NGenKeyword` \(0x20\)|Informatif \(4\)|  
|Fournisseur d’arrêt `JitRundownKeyword` \(0x10\)|Informatif \(4\)|  
|Fournisseur d’arrêt `NGENRundownKeyword` \(0x20\)|Informatif \(4\)|  
...
|Mot clé pour déclencher l'événement|Niveau|  
|-----------------------------------------|------------|  
|Fournisseur d’arrêt `AppDomainResourceManagementRundownKeyword` \(0x800\)|Informatif \(4\)|  
|Fournisseur d’arrêt `JitRundownKeyword` \(0x10\)|Informatif \(4\)|  
|Fournisseur d’arrêt `NGENRundownKeyword` \(0x20\)|Informatif \(4\)|  
...
|Fournisseur de runtime `NGenKeyword` \(0x20\)|Détaillé \(5\)|  
