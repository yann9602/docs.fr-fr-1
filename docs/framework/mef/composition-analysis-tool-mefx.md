---
title: "Outil d&#39;analyse de la composition (Mefx) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "analyse de la composition (outil MEF)"
  - "MEF, outil d’analyse de la composition"
  - "Mefx [MEF], outil d’analyse de la composition"
...
---
# Outil d&#39;analyse de la composition (Mefx)
...
## Obtention de Mefx  
 Mefx est disponible sur Codeplex à l’adresse [Managed Extensibility Framework](http://go.microsoft.com/fwlink/?LinkID=187078). Il vous suffit de télécharger l'outil et de le décompresser.  
...
## Liste des importations et exportations  
