---
title: "MissingMetadataException, classe (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Méthode|Description|  
|-------------|-----------------|  
|`public bool Equals(Object obj)`|Détermine si l'objet spécifié est identique à l'objet actif.  \(Hérité de <xref:System.Exception?displayProperty=fullName>.\)|  
