...
## <a name="see-also"></a>Voir aussi  
 [Informations de référence sur le fichier de configuration des directives runtime (rd.xml)](../../../docs/framework/net-native/runtime-directives-rd-xml-configuration-file-reference.md)   
