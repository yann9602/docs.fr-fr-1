---
title: "R&#233;flexion et .NET Native | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  Pour une vue d'ensemble du processus de compilation .NET Native apportant des informations générales sur la nécessité d'un fichier de directives de runtime, consultez [Compilation et .NET natif](../../../docs/framework/net-native/net-native-and-compilation.md).  
