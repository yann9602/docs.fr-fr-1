...
Dans [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], *Ildasm.exe* affiche les attributs qui sont appliqués aux implémentations d’interfaces, comme indiqué dans l’extrait suivant de la sortie d’*Ildasm.exe* :
