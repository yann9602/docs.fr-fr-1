...
## Exemple de fichier de réponse  
 La liste suivante montre un exemple de fichier de réponse, `response.rsp`.  Pour plus d'informations sur les fichiers de réponse, consultez [Response Files](../Topic/MSBuild%20Response%20Files.md).  
