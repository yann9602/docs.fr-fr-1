...
|------------------|------------------|  
|ScrollBar<br /><br /> -Bouton (2 ou 4)<br />-Thumb (0 ou 1)|Non applicable. Le contrôle de barre de défilement n’a pas de contenu.|  
...
|Événement de modification de propriété<xref:System.Windows.Automation.RangeValuePatternIdentifiers.ValueProperty> |Selon le cas|Aucune|  
