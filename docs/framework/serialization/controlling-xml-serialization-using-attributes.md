---
title: "Contr&#244;le de la s&#233;rialisation&#160;XML &#224; l&#39;aide d&#39;attributs | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Les attributs peuvent être utilisés pour contrôler la sérialisation XML d'un objet ou pour créer un flux de données XML différent à partir du même ensemble de classes.Pour plus d'informations sur la création d'un flux de données XML différent, consultez [Comment : spécifier un nom d'élément différent pour un flux XML](../../../docs/framework/serialization/how-to-specify-an-alternate-element-name-for-an-xml-stream.md).  
