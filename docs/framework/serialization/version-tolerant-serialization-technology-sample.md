---
title: "S&#233;rialisation avec tol&#233;rance de version, exemple de technologie | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  Tapez **msbuild.exe \<ver\> application.sln** au niveau de la ligne de commande \(où \<ver\> désigne v1 ou v2\).  
...
2.  Tapez **runme.cmd** à la ligne de commande pour exécuter en même temps les deux applications.  
