...
## Capture de l'entrée de la souris  
 ...
 Enfin, cette méthode retourne l'état de la capture de la souris.  Cela permet à l'objet [GamePieceCollection](../../../docs/framework/common-client-technologies/creating-the-gamepiececollection-class.md) de gérer la capture lorsqu'il existe plusieurs pièces de jeu.  
