...
---
# Full Code Listings
Cette rubrique contient la liste de tous les codes pour une application qui utilise des processeurs [Manipulations and Inertia](../../../docs/framework/common-client-technologies/manipulations-and-inertia.md).  
  
## Classe GamePiece  
 Le code suivant montre l'intégralité de la classe **GamePiece**.  
...
## Classe GamePieceCollection  
 Le code suivant montre l'intégralité de la classe **GamePieceCollection**.  
...
## Classe Game1  
 Le code suivant montre l'intégralité de la classe **Game1**.  
