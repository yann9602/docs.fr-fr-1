---
title: "Migration &#224; partir du .NET&#160;Framework&#160;1.1 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 1.1, migrer vers .NET Framework 4.5"
  - ".NET Framework 4.5, migration à partir de 1.1"
...
---
# Migration &#224; partir du .NET&#160;Framework&#160;1.1
...
## Types et membres obsolètes  
 ...
 Pour évaluer l’impact des types et membres déconseillés depuis la mise en production de [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)], consultez [Éléments obsolètes dans la bibliothèque de classes](../../../docs/framework/whats-new/whats-obsolete.md). Passez en revue les listes de types et membres obsolètes pour le [!INCLUDE[net_v20SP1_short](../../../includes/net-v20sp1-short-md.md)], le [!INCLUDE[net_v35_short](../../../includes/net-v35-short-md.md)] et le [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)].