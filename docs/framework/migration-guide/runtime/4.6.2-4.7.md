...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-47"></a>Modifications du runtime pour la Migration à partir de .NET Framework 4.6.2 à 4.7

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Si vous effectuez une migration à partir de .NET Framework 4.6.2 à 4.7, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :
