---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.0 et 4.5"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="16a32-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.0 et 4.5</span><span class="sxs-lookup"><span data-stu-id="16a32-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="16a32-103">Si vous migrez à partir de .NET Framework 4.0, 4.5, consultez les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="16a32-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="16a32-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="16a32-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="16a32-105">Principal</span><span class="sxs-lookup"><span data-stu-id="16a32-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="16a32-106">Données</span><span class="sxs-lookup"><span data-stu-id="16a32-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="16a32-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="16a32-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="16a32-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="16a32-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="16a32-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="16a32-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="16a32-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="16a32-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="16a32-111">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="16a32-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="16a32-112">Impression</span><span class="sxs-lookup"><span data-stu-id="16a32-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="16a32-113">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="16a32-113">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="16a32-114">Applications Web</span><span class="sxs-lookup"><span data-stu-id="16a32-114">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="16a32-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="16a32-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="16a32-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="16a32-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="16a32-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="16a32-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="16a32-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="16a32-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="16a32-119">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="16a32-119">XML, XSLT</span></span>
