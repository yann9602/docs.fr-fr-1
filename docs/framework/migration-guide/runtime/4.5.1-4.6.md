---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5.1 pour 4.6"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="0d2bd-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5.1 pour 4.6</span><span class="sxs-lookup"><span data-stu-id="0d2bd-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0d2bd-103">Si vous effectuez une migration depuis le .NET Framework 4.5.1 pour 4.6, consultez les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="0d2bd-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="0d2bd-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0d2bd-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0d2bd-105">Principal</span><span class="sxs-lookup"><span data-stu-id="0d2bd-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0d2bd-106">Données</span><span class="sxs-lookup"><span data-stu-id="0d2bd-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="0d2bd-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="0d2bd-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0d2bd-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0d2bd-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="0d2bd-109">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="0d2bd-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0d2bd-110">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="0d2bd-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0d2bd-111">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="0d2bd-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0d2bd-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0d2bd-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="0d2bd-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="0d2bd-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0d2bd-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0d2bd-114">Windows Presentation Foundation (WPF)</span></span>
