...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a><span data-ttu-id="7ebc1-102">Modifications du Runtime pour la migration de .NET Framework 4.0 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="7ebc1-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="7ebc1-103">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="7ebc1-103">If you are migrating from the .NET Framework 4.0 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="7ebc1-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="7ebc1-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="7ebc1-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7ebc1-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7ebc1-106">Principal</span><span class="sxs-lookup"><span data-stu-id="7ebc1-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7ebc1-107">Données</span><span class="sxs-lookup"><span data-stu-id="7ebc1-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7ebc1-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7ebc1-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7ebc1-109">Globalisation</span><span class="sxs-lookup"><span data-stu-id="7ebc1-109">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="7ebc1-110">JIT</span><span class="sxs-lookup"><span data-stu-id="7ebc1-110">JIT</span></span>
...
## <a name="linq"></a><span data-ttu-id="7ebc1-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="7ebc1-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="7ebc1-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="7ebc1-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="7ebc1-113">Réseau</span><span class="sxs-lookup"><span data-stu-id="7ebc1-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="7ebc1-114">Impression</span><span class="sxs-lookup"><span data-stu-id="7ebc1-114">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="7ebc1-115">Sécurité</span><span class="sxs-lookup"><span data-stu-id="7ebc1-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7ebc1-116">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="7ebc1-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="7ebc1-117">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="7ebc1-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="7ebc1-118">Outils</span><span class="sxs-lookup"><span data-stu-id="7ebc1-118">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="7ebc1-119">Applications Web</span><span class="sxs-lookup"><span data-stu-id="7ebc1-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7ebc1-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7ebc1-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="7ebc1-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="7ebc1-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7ebc1-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7ebc1-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="7ebc1-123">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="7ebc1-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="7ebc1-124">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="7ebc1-124">XML, XSLT</span></span>
