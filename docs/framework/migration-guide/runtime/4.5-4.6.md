---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5 à 4.6"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="5b6a0-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5 à 4.6</span><span class="sxs-lookup"><span data-stu-id="5b6a0-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="5b6a0-103">Si vous effectuez une migration depuis le .NET Framework 4.5 vers la version 4.6, consultez les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="5b6a0-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="5b6a0-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="5b6a0-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="5b6a0-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="5b6a0-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="5b6a0-106">Principal</span><span class="sxs-lookup"><span data-stu-id="5b6a0-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="5b6a0-107">Données</span><span class="sxs-lookup"><span data-stu-id="5b6a0-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="5b6a0-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="5b6a0-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="5b6a0-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="5b6a0-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="5b6a0-110">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="5b6a0-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="5b6a0-111">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="5b6a0-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="5b6a0-112">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="5b6a0-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="5b6a0-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="5b6a0-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="5b6a0-114">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="5b6a0-114">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="5b6a0-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="5b6a0-115">Windows Presentation Foundation (WPF)</span></span>
