---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5 pour 4.5.2"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="752b5-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5 pour 4.5.2</span><span class="sxs-lookup"><span data-stu-id="752b5-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="752b5-103">Si vous effectuez une migration depuis le .NET Framework 4.5 vers 4.5.2, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="752b5-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="752b5-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="752b5-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="752b5-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="752b5-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="752b5-106">Principal</span><span class="sxs-lookup"><span data-stu-id="752b5-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="752b5-107">Données</span><span class="sxs-lookup"><span data-stu-id="752b5-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="752b5-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="752b5-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="752b5-109">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="752b5-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="752b5-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="752b5-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="752b5-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="752b5-111">Windows Presentation Foundation (WPF)</span></span>
