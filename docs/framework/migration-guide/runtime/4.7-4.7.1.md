...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="9be81-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.7 à 4.7.1</span><span class="sxs-lookup"><span data-stu-id="9be81-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="9be81-103">Si vous effectuez une migration à partir de la 4.7 Framework .NET vers 4.7.1, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="9be81-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="9be81-104">JIT</span><span class="sxs-lookup"><span data-stu-id="9be81-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="9be81-105">Sécurité</span><span class="sxs-lookup"><span data-stu-id="9be81-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9be81-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9be81-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9be81-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9be81-107">Windows Presentation Foundation (WPF)</span></span>
