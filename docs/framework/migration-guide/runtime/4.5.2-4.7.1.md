...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a>Modifications du runtime pour la Migration à partir de .NET Framework 4.5.2 pour 4.7.1
