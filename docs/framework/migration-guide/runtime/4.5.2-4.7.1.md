---
title: Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.7.1 | Microsoft Docs
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="8a775-102">Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.7.1</span><span class="sxs-lookup"><span data-stu-id="8a775-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="8a775-103">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.7.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="8a775-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="8a775-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="8a775-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="8a775-105">Principal</span><span class="sxs-lookup"><span data-stu-id="8a775-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="8a775-106">Données</span><span class="sxs-lookup"><span data-stu-id="8a775-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="8a775-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="8a775-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="8a775-108">Globalisation</span><span class="sxs-lookup"><span data-stu-id="8a775-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="8a775-109">Réseau</span><span class="sxs-lookup"><span data-stu-id="8a775-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="8a775-110">Sécurité</span><span class="sxs-lookup"><span data-stu-id="8a775-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="8a775-111">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="8a775-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="8a775-112">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="8a775-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="8a775-113">Outils</span><span class="sxs-lookup"><span data-stu-id="8a775-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="8a775-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="8a775-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="8a775-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="8a775-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="8a775-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="8a775-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="8a775-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="8a775-117">Windows Workflow Foundation (WF)</span></span>
