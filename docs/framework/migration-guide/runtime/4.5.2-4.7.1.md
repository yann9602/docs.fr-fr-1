---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5.2 pour 4.7.1 | Documents Microsoft"
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="cd063-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5.2 pour 4.7.1</span><span class="sxs-lookup"><span data-stu-id="cd063-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cd063-103">Si vous effectuez une migration à partir de .NET Framework 4.5.2 pour 4.7.1, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="cd063-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="cd063-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cd063-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cd063-105">Principal</span><span class="sxs-lookup"><span data-stu-id="cd063-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="cd063-106">Données</span><span class="sxs-lookup"><span data-stu-id="cd063-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="cd063-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="cd063-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="cd063-108">Globalisation</span><span class="sxs-lookup"><span data-stu-id="cd063-108">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="cd063-109">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="cd063-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="cd063-110">Sécurité</span><span class="sxs-lookup"><span data-stu-id="cd063-110">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cd063-111">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="cd063-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="cd063-112">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="cd063-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="cd063-113">Outils</span><span class="sxs-lookup"><span data-stu-id="cd063-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cd063-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cd063-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="cd063-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="cd063-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cd063-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cd063-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="cd063-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="cd063-117">Windows Workflow Foundation (WF)</span></span>
