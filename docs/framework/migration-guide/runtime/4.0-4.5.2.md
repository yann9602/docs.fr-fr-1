...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a>Modifications du runtime pour la Migration à partir de .NET Framework 4.0 pour 4.5.2
