---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5.1 pour 4.5.2"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="c34f2-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5.1 pour 4.5.2</span><span class="sxs-lookup"><span data-stu-id="c34f2-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="c34f2-103">Si vous effectuez une migration à partir de .NET Framework 4.5.1 pour 4.5.2, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="c34f2-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c34f2-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c34f2-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="c34f2-105">Données</span><span class="sxs-lookup"><span data-stu-id="c34f2-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c34f2-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c34f2-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c34f2-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c34f2-107">Windows Presentation Foundation (WPF)</span></span>
