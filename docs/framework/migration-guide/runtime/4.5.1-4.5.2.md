...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="084b7-102">Modifications du Runtime pour la migration de .NET Framework 4.5.1 vers la version 4.5.2</span><span class="sxs-lookup"><span data-stu-id="084b7-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="084b7-103">Si vous effectuez une migration de .NET Framework 4.5.1 vers la version 4.5.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="084b7-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="084b7-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="084b7-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="084b7-105">Données</span><span class="sxs-lookup"><span data-stu-id="084b7-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="084b7-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="084b7-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="084b7-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="084b7-107">Windows Presentation Foundation (WPF)</span></span>
