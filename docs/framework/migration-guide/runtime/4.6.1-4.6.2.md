---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.6.1 à 4.6.2"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="e94b4-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.6.1 à 4.6.2</span><span class="sxs-lookup"><span data-stu-id="e94b4-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e94b4-103">Si vous effectuez une migration à partir de .NET Framework 4.6.1 à 4.6.2, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="e94b4-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="e94b4-104">Principal</span><span class="sxs-lookup"><span data-stu-id="e94b4-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e94b4-105">Données</span><span class="sxs-lookup"><span data-stu-id="e94b4-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="e94b4-106">Globalisation</span><span class="sxs-lookup"><span data-stu-id="e94b4-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="e94b4-107">Sécurité</span><span class="sxs-lookup"><span data-stu-id="e94b4-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e94b4-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e94b4-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e94b4-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e94b4-109">Windows Presentation Foundation (WPF)</span></span>
