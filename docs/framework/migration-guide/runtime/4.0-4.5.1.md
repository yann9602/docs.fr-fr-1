...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="30343-102">Modifications du Runtime pour la migration de .NET Framework 4.0 vers la version 4.5.1</span><span class="sxs-lookup"><span data-stu-id="30343-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="30343-103">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.5.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="30343-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="30343-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="30343-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="30343-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="30343-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="30343-106">Principal</span><span class="sxs-lookup"><span data-stu-id="30343-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="30343-107">Données</span><span class="sxs-lookup"><span data-stu-id="30343-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="30343-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="30343-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="30343-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="30343-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="30343-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="30343-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="30343-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="30343-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="30343-112">Réseau</span><span class="sxs-lookup"><span data-stu-id="30343-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="30343-113">Impression</span><span class="sxs-lookup"><span data-stu-id="30343-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="30343-114">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="30343-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="30343-115">Applications Web</span><span class="sxs-lookup"><span data-stu-id="30343-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="30343-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="30343-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="30343-117">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="30343-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="30343-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="30343-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="30343-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="30343-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="30343-120">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="30343-120">XML, XSLT</span></span>
