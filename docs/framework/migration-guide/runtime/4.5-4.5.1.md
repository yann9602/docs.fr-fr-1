...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="78cb5-102">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.5.1</span><span class="sxs-lookup"><span data-stu-id="78cb5-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="78cb5-103">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.5.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="78cb5-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="78cb5-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="78cb5-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="78cb5-105">Principal</span><span class="sxs-lookup"><span data-stu-id="78cb5-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="78cb5-106">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="78cb5-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="78cb5-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="78cb5-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="78cb5-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="78cb5-108">Windows Presentation Foundation (WPF)</span></span>
