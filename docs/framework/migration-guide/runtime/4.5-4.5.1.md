---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5 à 4.5.1"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="86592-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5 à 4.5.1</span><span class="sxs-lookup"><span data-stu-id="86592-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="86592-103">Si vous effectuez une migration depuis le .NET Framework 4.5 vers la version 4.5.1, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="86592-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="86592-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="86592-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="86592-105">Principal</span><span class="sxs-lookup"><span data-stu-id="86592-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="86592-106">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="86592-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="86592-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="86592-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="86592-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="86592-108">Windows Presentation Foundation (WPF)</span></span>
