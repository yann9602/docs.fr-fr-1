---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.5.2 à 4.7"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a><span data-ttu-id="75547-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.5.2 à 4.7</span><span class="sxs-lookup"><span data-stu-id="75547-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="75547-103">Si vous effectuez une migration à partir de .NET Framework 4.5.2 à 4.7, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="75547-103">If you are migrating from the .NET Framework 4.5.2 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="75547-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="75547-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="75547-105">Principal</span><span class="sxs-lookup"><span data-stu-id="75547-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="75547-106">Données</span><span class="sxs-lookup"><span data-stu-id="75547-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="75547-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="75547-107">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="75547-108">Globalisation</span><span class="sxs-lookup"><span data-stu-id="75547-108">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="75547-109">JIT</span><span class="sxs-lookup"><span data-stu-id="75547-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="75547-110">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="75547-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="75547-111">Sécurité</span><span class="sxs-lookup"><span data-stu-id="75547-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="75547-112">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="75547-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="75547-113">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="75547-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="75547-114">Outils</span><span class="sxs-lookup"><span data-stu-id="75547-114">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="75547-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="75547-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="75547-116">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="75547-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="75547-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="75547-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="75547-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="75547-118">Windows Workflow Foundation (WF)</span></span>
