...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a>Modifications du runtime pour la Migration à partir de .NET Framework 4.5 pour 4.7.1
