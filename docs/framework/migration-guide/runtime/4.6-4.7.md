...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="35b5c-102">Modifications du Runtime pour la migration de .NET Framework 4.6 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="35b5c-102">Runtime Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="35b5c-103">Si vous effectuez une migration de .NET Framework 4.6 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="35b5c-103">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="35b5c-104">Principal</span><span class="sxs-lookup"><span data-stu-id="35b5c-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="35b5c-105">Données</span><span class="sxs-lookup"><span data-stu-id="35b5c-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="35b5c-106">Globalisation</span><span class="sxs-lookup"><span data-stu-id="35b5c-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="35b5c-107">JIT</span><span class="sxs-lookup"><span data-stu-id="35b5c-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="35b5c-108">Sécurité</span><span class="sxs-lookup"><span data-stu-id="35b5c-108">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="35b5c-109">Outils</span><span class="sxs-lookup"><span data-stu-id="35b5c-109">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="35b5c-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="35b5c-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="35b5c-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="35b5c-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="35b5c-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="35b5c-112">Windows Workflow Foundation (WF)</span></span>
