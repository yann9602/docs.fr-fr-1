...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a>Modifications du runtime pour la Migration à partir de .NET Framework 4.5.2 pour 4.6

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Si vous effectuez une migration depuis le .NET Framework 4.5.2 pour 4.6, consultez les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :
