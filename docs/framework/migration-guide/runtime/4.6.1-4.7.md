...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="54d98-102">Modifications du Runtime pour la migration de .NET Framework 4.6.1 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="54d98-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="54d98-103">Si vous effectuez une migration de .NET Framework 4.6.1 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="54d98-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="54d98-104">Principal</span><span class="sxs-lookup"><span data-stu-id="54d98-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="54d98-105">Données</span><span class="sxs-lookup"><span data-stu-id="54d98-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="54d98-106">Globalisation</span><span class="sxs-lookup"><span data-stu-id="54d98-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="54d98-107">JIT</span><span class="sxs-lookup"><span data-stu-id="54d98-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="54d98-108">Sécurité</span><span class="sxs-lookup"><span data-stu-id="54d98-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="54d98-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="54d98-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="54d98-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="54d98-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="54d98-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="54d98-111">Windows Workflow Foundation (WF)</span></span>
