---
title: "Modifications du runtime pour la Migration à partir de .NET Framework 4.6.1 à 4.7.1 | Documents Microsoft"
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a><span data-ttu-id="b68a9-102">Modifications du runtime pour la Migration à partir de .NET Framework 4.6.1 à 4.7.1</span><span class="sxs-lookup"><span data-stu-id="b68a9-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b68a9-103">Si vous effectuez une migration à partir de .NET Framework 4.6.1 à 4.7.1, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="b68a9-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="b68a9-104">Principal</span><span class="sxs-lookup"><span data-stu-id="b68a9-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b68a9-105">Données</span><span class="sxs-lookup"><span data-stu-id="b68a9-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="b68a9-106">Globalisation</span><span class="sxs-lookup"><span data-stu-id="b68a9-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="b68a9-107">Sécurité</span><span class="sxs-lookup"><span data-stu-id="b68a9-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b68a9-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b68a9-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b68a9-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b68a9-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="b68a9-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="b68a9-110">Windows Workflow Foundation (WF)</span></span>
