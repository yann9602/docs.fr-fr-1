---
title: Modifications du Runtime pour la migration de .NET Framework 4.6.1 vers la version 4.7.1 | Microsoft Docs
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a><span data-ttu-id="7cfe5-102">Modifications du Runtime pour la migration de .NET Framework 4.6.1 vers la version 4.7.1</span><span class="sxs-lookup"><span data-stu-id="7cfe5-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="7cfe5-103">Si vous effectuez une migration de .NET Framework 4.6.1 vers la version 4.7.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="7cfe5-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="7cfe5-104">Principal</span><span class="sxs-lookup"><span data-stu-id="7cfe5-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7cfe5-105">Données</span><span class="sxs-lookup"><span data-stu-id="7cfe5-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7cfe5-106">Globalisation</span><span class="sxs-lookup"><span data-stu-id="7cfe5-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="7cfe5-107">Sécurité</span><span class="sxs-lookup"><span data-stu-id="7cfe5-107">Security</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7cfe5-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7cfe5-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="7cfe5-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="7cfe5-110">Windows Workflow Foundation (WF)</span></span>
