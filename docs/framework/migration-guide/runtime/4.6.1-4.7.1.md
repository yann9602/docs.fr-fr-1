...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a>Modifications du runtime pour la Migration à partir de .NET Framework 4.6.1 à 4.7.1
