---
title: "Compatibilité des applications dans le .NET Framework 4.7 | Microsoft Docs"
ms.custom: 
ms.date: 04/07/2017
...
---
# <a name="application-compatibility-in-the-net-framework-47"></a>Compatibilité d'applications dans le .NET Framework 4.7
Cette rubrique fournit des liens vers des informations sur les problèmes de compatibilité des applications entre le .NET Framework 4.6.2 et 4.7. Les problèmes sont répartis en deux catégories :  
  
 [Modifications du runtime](../../../docs/framework/migration-guide/runtime-changes-in-the-net-framework-4-7.md)  
 Les modifications du runtime concernent toutes les applications qui s’exécutent sous le .NET Framework 4.7 et qui utilisent une fonctionnalité particulière.  
  
 [Modifications de reciblage](../../../docs/framework/migration-guide/retargeting-changes-in-the-net-framework-4-7.md)  
 Les modifications de reciblage concernent les applications qui sont recompilées pour cibler le .NET Framework 4.7. Ils comprennent :  
...
-   Modifications de l'environnement d'exécution. Ces modifications concernent uniquement les applications qui ciblent particulièrement le .NET Framework 4.7. Les applications qui ciblent des versions antérieures de .NET Framework se comportent comme elles le faisaient dans ces versions.  
  
Dans les deux rubriques, nous avons classé les éléments individuels en fonction de leur impact, comme suit :  
