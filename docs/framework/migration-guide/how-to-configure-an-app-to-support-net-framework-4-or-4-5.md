---
title: "Comment&#160;: configurer une application pour prendre en charge le .NET Framework&#160;4 ou 4.5 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Comment&#160;: configurer une application pour prendre en charge le .NET Framework&#160;4 ou 4.5
...
### Pour configurer votre application afin qu'elle s'exécute sur .NET Framework 4 ou 4.5  
...
2.  Ajoutez l'élément [\<supportedRuntime\>](../../../docs/framework/configure-apps/file-schema/startup/supportedruntime-element.md) dans le fichier de configuration de l'application, comme suit :  
    ...
    -   .NET Framework 4 et 4.5 \(y compris les versions intermédiaires telles que 4.5.1\) : "v4.0"  
