...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a>Reciblage des modifications pour la Migration à partir de .NET Framework 4.5.2 pour 4.6
