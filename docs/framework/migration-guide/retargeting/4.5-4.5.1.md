...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="1b05b-102">Modifications de reciblage pour la migration de .NET Framework 4.5 vers la version 4.5.1</span><span class="sxs-lookup"><span data-stu-id="1b05b-102">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="1b05b-103">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.5.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="1b05b-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="1b05b-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="1b05b-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="1b05b-105">Principal</span><span class="sxs-lookup"><span data-stu-id="1b05b-105">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="1b05b-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="1b05b-106">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="1b05b-107">MSBuild</span><span class="sxs-lookup"><span data-stu-id="1b05b-107">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1b05b-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1b05b-108">Windows Presentation Foundation (WPF)</span></span>
