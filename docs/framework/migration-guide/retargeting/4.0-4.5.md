...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a>Reciblage des modifications pour la Migration à partir de .NET Framework 4.0 et 4.5

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Si vous migrez à partir de .NET Framework 4.0, 4.5, consultez les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :
