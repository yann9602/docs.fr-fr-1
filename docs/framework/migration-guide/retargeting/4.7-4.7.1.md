...
---
# <a name="retargeting-changes-for-migration-from-net-framework-47-to-471"></a>Reciblage des modifications pour la Migration à partir de .NET Framework 4.7 à 4.7.1
