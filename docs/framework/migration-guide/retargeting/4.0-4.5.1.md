...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="43874-102">Modifications de reciblage pour la migration de .NET Framework 4.0 vers la version 4.5.1</span><span class="sxs-lookup"><span data-stu-id="43874-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="43874-103">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.5.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="43874-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="43874-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="43874-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="43874-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="43874-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="43874-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="43874-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="43874-107">Principal</span><span class="sxs-lookup"><span data-stu-id="43874-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="43874-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="43874-108">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="43874-109">MSBuild</span><span class="sxs-lookup"><span data-stu-id="43874-109">MSBuild</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="43874-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="43874-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="43874-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="43874-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="43874-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="43874-112">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="43874-113">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="43874-113">XML, XSLT</span></span>
