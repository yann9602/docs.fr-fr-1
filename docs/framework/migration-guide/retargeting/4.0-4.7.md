...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-47"></a><span data-ttu-id="af6ab-102">Modifications de reciblage pour la migration de .NET Framework 4.0 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="af6ab-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="af6ab-103">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="af6ab-103">If you are migrating from the .NET Framework 4.0 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="af6ab-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="af6ab-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="af6ab-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="af6ab-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="af6ab-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="af6ab-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="af6ab-107">Principal</span><span class="sxs-lookup"><span data-stu-id="af6ab-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="af6ab-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="af6ab-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="af6ab-109">JIT</span><span class="sxs-lookup"><span data-stu-id="af6ab-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="af6ab-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="af6ab-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="af6ab-111">Réseau</span><span class="sxs-lookup"><span data-stu-id="af6ab-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="af6ab-112">Sécurité</span><span class="sxs-lookup"><span data-stu-id="af6ab-112">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="af6ab-113">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="af6ab-113">Visual Basic .NET</span></span>

[!include[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="af6ab-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="af6ab-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="af6ab-115">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="af6ab-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="af6ab-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="af6ab-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="af6ab-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="af6ab-117">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="af6ab-118">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="af6ab-118">XML, XSLT</span></span>
