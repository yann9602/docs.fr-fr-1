...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-47"></a>Reciblage des modifications pour la Migration à partir de .NET Framework 4.0 à 4.7

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Si vous effectuez une migration à partir de .NET Framework 4.0 à 4.7, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :
