...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-461"></a>Reciblage des modifications pour la Migration à partir de .NET Framework 4.5 pour 4.6.1

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Si vous effectuez une migration depuis le .NET Framework 4.5 vers 4.6.1, passez en revue les rubriques suivantes pour les éventuels problèmes de compatibilité susceptibles d’affecter votre application :
