...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-47"></a><span data-ttu-id="dd12c-102">Modifications de reciblage pour la migration de .NET Framework 4.6 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="dd12c-102">Retargeting Changes for Migration from .NET Framework 4.6 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="dd12c-103">Si vous effectuez une migration de .NET Framework 4.6 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="dd12c-103">If you are migrating from the .NET Framework 4.6 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="dd12c-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dd12c-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="dd12c-105">Principal</span><span class="sxs-lookup"><span data-stu-id="dd12c-105">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="dd12c-106">Réseau</span><span class="sxs-lookup"><span data-stu-id="dd12c-106">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="dd12c-107">Sécurité</span><span class="sxs-lookup"><span data-stu-id="dd12c-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="dd12c-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="dd12c-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="dd12c-109">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="dd12c-109">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dd12c-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dd12c-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="dd12c-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="dd12c-111">Windows Workflow Foundation (WF)</span></span>
