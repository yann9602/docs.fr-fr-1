...
Les rubriques de cette section décrivent les activités fournies par le système disponibles dans [!INCLUDE[wf](../../../includes/wf-md.md)].  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit les activités fournies par le système disponibles dans [!INCLUDE[wf1](../../../includes/wf1-md.md)].  
 ...
 Explique comment créer des activités personnalisées à l'aide des méthodes <xref:System.Activities.CodeActivity> ou <xref:System.Activities.NativeActivity>.
