...
###  <a name="BKMK_CreatePersistenceDatabase"></a><span data-ttu-id="4fa0f-122">Pour créer la base de données de persistance</span><span class="sxs-lookup"><span data-stu-id="4fa0f-122">To create the persistence database</span></span>  
...
###  <a name="BKMK_AddReference"></a><span data-ttu-id="4fa0f-138">Pour ajouter la référence aux assemblys DurableInstancing</span><span class="sxs-lookup"><span data-stu-id="4fa0f-138">To add the reference to the DurableInstancing assemblies</span></span>  
...
###  <a name="BKMK_CreateForm"></a><span data-ttu-id="4fa0f-143">Pour créer le formulaire hôte de flux de travail</span><span class="sxs-lookup"><span data-stu-id="4fa0f-143">To create the workflow host form</span></span>  
...
###  <a name="BKMK_AddHelperMethods"></a><span data-ttu-id="4fa0f-236">Pour ajouter les propriétés et méthodes d’assistance de l’écran</span><span class="sxs-lookup"><span data-stu-id="4fa0f-236">To add the properties and helper methods of the form</span></span>  
...
###  <a name="BKMK_ConfigureWorkflowApplication"></a><span data-ttu-id="4fa0f-258">Pour configurer le magasin d’instances, les gestionnaires de cycle de vie de workflow et les extensions</span><span class="sxs-lookup"><span data-stu-id="4fa0f-258">To configure the instance store, workflow lifecycle handlers, and extensions</span></span>  
...
###  <a name="BKMK_WorkflowVersionMap"></a><span data-ttu-id="4fa0f-277">Pour activer le démarrage et la reprise de plusieurs types de flux de travail</span><span class="sxs-lookup"><span data-stu-id="4fa0f-277">To enable starting and resuming multiple workflow types</span></span>  
...
###  <a name="BKMK_StartWorkflow"></a><span data-ttu-id="4fa0f-288">Pour démarrer un nouveau flux de travail</span><span class="sxs-lookup"><span data-stu-id="4fa0f-288">To start a new workflow</span></span>  
...
###  <a name="BKMK_ResumeWorkflow"></a><span data-ttu-id="4fa0f-303">Pour reprendre un workflow</span><span class="sxs-lookup"><span data-stu-id="4fa0f-303">To resume a workflow</span></span>  
...
###  <a name="BKMK_TerminateWorkflow"></a><span data-ttu-id="4fa0f-318">Pour mettre fin à un flux de travail</span><span class="sxs-lookup"><span data-stu-id="4fa0f-318">To terminate a workflow</span></span>  
...
###  <a name="BKMK_BuildAndRun"></a><span data-ttu-id="4fa0f-327">Pour générer et exécuter l’application</span><span class="sxs-lookup"><span data-stu-id="4fa0f-327">To build and run the application</span></span>  
