...
## Options de signet  
 La classe <xref:System.Activities.BookmarkOptions> spécifie le type de <xref:System.Activities.Bookmark> qui est créé.Les valeurs non mutuellement exclusives possibles sont <xref:System.Activities.BookmarkOptions>, <xref:System.Activities.BookmarkOptions> et <xref:System.Activities.BookmarkOptions>.Utilisez <xref:System.Activities.BookmarkOptions>, la valeur par défaut, lors de la création d'un <xref:System.Activities.Bookmark> attendu pour être repris une seule fois.Utilisez <xref:System.Activities.BookmarkOptions> lors de la création d'un <xref:System.Activities.Bookmark> qui peut être repris plusieurs fois.Utilisez <xref:System.Activities.BookmarkOptions> lors de la création d'un <xref:System.Activities.Bookmark> qui ne peut jamais être continué.Contrairement aux signets créés à l'aide du <xref:System.Activities.BookmarkOptions> par défaut, les signets <xref:System.Activities.BookmarkOptions> n'empêchent pas une activité d'aboutir.  
...
## Résultat de reprise de signet  
 <xref:System.Activities.WorkflowApplication.ResumeBookmark%2A> retourne une valeur d'énumération <xref:System.Activities.BookmarkResumptionResult> pour indiquer les résultats de la demande de reprise de signet.Les valeurs de retour possibles sont <xref:System.Activities.BookmarkResumptionResult>, <xref:System.Activities.BookmarkResumptionResult> et <xref:System.Activities.BookmarkResumptionResult>.Les hôtes et extensions peuvent utiliser cette valeur pour déterminer comment continuer.