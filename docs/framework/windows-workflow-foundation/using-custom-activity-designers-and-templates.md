...
## <a name="in-this-section"></a>Dans cette section  
 [Guide pratique pour créer un concepteur d’activités personnalisé](../../../docs/framework/windows-workflow-foundation/how-to-create-a-custom-activity-designer.md)  
 ...
 [Guide pratique pour: créer un modèle d’activité personnalisé](../../../docs/framework/windows-workflow-foundation/how-to-create-a-custom-activity-template.md)  
