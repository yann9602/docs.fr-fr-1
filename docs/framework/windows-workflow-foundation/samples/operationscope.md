...
2.  Définissez plusieurs projets de démarrage en cliquant avec le bouton droit sur la solution dans l'Explorateur de solutions, puis en sélectionnant **Définir les projets de démarrage**.Ajoutez Scénario et Scenario\_Client \(dans cet ordre\) en tant que plusieurs projets de démarrage.  
...
4.  Appuyez sur CTRL\+F5 pour exécuter l'application.La console Scenario\_Client vous demande des entrées, et la sortie correspondante s'affiche sur la console Scenario.  
