...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Contient des exemples qui illustrent des scénarios qui utilisent la bibliothèque d'activités intégrée.  
  
 [Services](../../../../docs/framework/windows-workflow-foundation/samples/services.md)  
 Contient des exemples qui illustrent des scénarios qui utilisent des services de workflow.  
  
 [Transactions](../../../../docs/framework/windows-workflow-foundation/samples/transactions.md)  
 Contient des exemples qui illustrent des scénarios qui utilisent des transactions.  
