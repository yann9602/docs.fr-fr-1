---
title: "D&#233;lai durable | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
1.  Configurez la base de données de persistance.  
    ...
    2.  Accédez au répertoire du [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] \(C:\\Windows\\Microsoft.NET\\Framework\\v4.X\\\).  
...
2.  Exécutez [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] avec des autorisations élevées en cliquant avec le bouton droit sur l'icône de [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] et en sélectionnant **Exécuter en tant qu'administrateur**.  
