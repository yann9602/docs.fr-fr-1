---
title: "Traitement des commandes avec une strat&#233;gie | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  [!INCLUDE[crabout](../../../../includes/crabout-md.md)] les méthodes d'extension, consultez [Spécification C\# version 3.0](http://go.microsoft.com/fwlink/?LinkId=95402) \(page pouvant être en anglais\).  
...
-   `OrderProcessingPolicy`  
    ...
    -   `displayErrors`  
        ...
        1.  Elle appelle l'opérateur `+` surchargé pour copier le contenu des objets `invalidItemNumErrorCollection` et `invalidZipCodeErrorCollection` dans une instance `invalidOrdersCollection``OrderErrorCollection`.  
