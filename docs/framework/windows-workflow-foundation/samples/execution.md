...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [À l’aide de la classe WorkflowInvoker](../../../../docs/framework/windows-workflow-foundation/samples/using-the-workflowinvoker-class.md)  
 ...
 [Programme de résolution de signet pour WorkflowHostingEndpoint](../../../../docs/framework/windows-workflow-foundation/samples/bookmark-resolver-for-workflowhostingendpoint.md)  
