...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour créer un participant de suivi personnalisé](../../../docs/framework/windows-workflow-foundation/how-to-create-a-custom-tracking-participant.md)  
