---
title: "Meilleures pratiques de persistance | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Conception et implémentation de workflow durables  
 ...
 Windows Server AppFabric simplifie grandement la configuration et l'utilisation de la persistance.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Persistance Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkID=201200&clcid=0x409)  
...
### Scénario : le workflow utilise des activités de délai avec des durées courtes  
 ...
 Affectez une valeur supérieure ou égale à <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore.RunnableInstancesDetectionPeriod%2A> à <xref:System.ServiceModel.Activities.Description.WorkflowIdleBehavior.TimeToUnload%2A> pour conserver l'instance en mémoire pendant au moins une fréquence d'interrogation.  
