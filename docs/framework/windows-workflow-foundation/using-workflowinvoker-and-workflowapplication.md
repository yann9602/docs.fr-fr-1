---
title: "Utilisation de WorkflowInvoker et WorkflowApplication | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  <xref:System.TimeoutException> est levée uniquement si l'intervalle de délai d'attente est écoulé et que le workflow devient inactif pendant l'exécution.Un workflow qui excède le délai d'attente spécifié pour s'exécuter se termine avec succès si le workflow ne devient pas inactif.  
