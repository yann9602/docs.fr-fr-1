...
-   **TestArrayOfStructs2** exporté depuis PinvokeLib.dll.  
 ...
 [PinvokeLib.dll](http://msdn.microsoft.com/fr-fr/5d1438d7-9946-489d-8ede-6c694a08f614) est une bibliothèque non managée personnalisée qui contient des implémentations pour les fonctions précédemment répertoriées, ainsi que les deux variables de structure **MYPOINT** et **MYPERSON**. Ces structures contiennent les éléments suivants :  
...
## Voir aussi  
 [Marshaling des tableaux de types](http://msdn.microsoft.com/fr-fr/049b1c1b-228f-4445-88ec-91bc7fd4b1e8)   
 [Types de données d’appel de plateforme](http://msdn.microsoft.com/fr-fr/16014d9f-d6bd-481e-83f0-df11377c550f)   
