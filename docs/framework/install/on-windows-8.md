...
Le .NET Framework 4.7.1 est pris en charge sur Windows Server 2012. Cette version n’est pas prise en charge sur Windows 8.

Le .[NET Framework 4.7.1](https://www.microsoft.com/en-us/download/details.aspx?id=56115&desc=dotnet47) peut être utilisé pour exécuter des applications conçues pour le .NET Framework 4.0 ou version ultérieure.

## <a name="net-framework-46"></a>.NET Framework 4.6

Le [.NET Framework 4.6](https://www.microsoft.com/en-us/download/details.aspx?id=48130) est la dernière version prise en charge du .NET Framework sur Windows 8.
