...
Le .NET Framework 4.7.1 est pris en charge sur Windows Server 2012. Il n’est pas pris en charge sur Windows 8.
...
Le [.NET Framework 4.6](https://www.microsoft.com/en-us/download/details.aspx?id=48130) est la dernière version prise en charge .NET Framework sur Windows 8.
