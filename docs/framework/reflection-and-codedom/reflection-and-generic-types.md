---
title: "R&#233;flexion et types g&#233;n&#233;riques | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   Si une instance de <xref:System.Type> représente un type générique, elle inclut un tableau de types qui représentent les paramètres de type \(pour les définitions de type générique\) ou les arguments de type \(pour les types construits\). Il en est de même d'une instance de la classe <xref:System.Reflection.MethodInfo> qui représente une méthode générique.  
 ...
 Pour obtenir un exemple de code illustrant les méthodes présentées ici, consultez [Comment : examiner et instancier des types génériques avec la réflexion](../../../docs/framework/reflection-and-codedom/how-to-examine-and-instantiate-generic-types-with-reflection.md).  
...
### Obtention d'une définition de type ou de méthode générique  
...
|Titre|Description|  
|-----------|-----------------|  
|[Comment : examiner et instancier des types génériques avec la réflexion](../../../docs/framework/reflection-and-codedom/how-to-examine-and-instantiate-generic-types-with-reflection.md)|Montre comment utiliser les propriétés et méthodes de <xref:System.Type> et <xref:System.Reflection.MethodInfo> pour examiner des types génériques.|  
...
|[Comment : définir un type générique avec l'émission de réflexion](../../../docs/framework/reflection-and-codedom/how-to-define-a-generic-type-with-reflection-emit.md)|Montre comment utiliser l'émission de réflexion pour générer des types génériques dans des assemblys dynamiques.|  
