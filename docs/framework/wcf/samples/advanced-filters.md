---
title: "Filtres avanc&#233;s | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>   
>  `<LecteurInstall>:\WF_WCF_Samples\WCF\Basic\RoutingServices\AdvancedFilters`  
...
|------------|-----------|--------------|  
|If \(has header\) \[contient un en\-tête\]|Rounding \[arrondi\]|2|  
|If \(showed up on Ep2\) \[apparu sur Ep2\]|Regular \[normale\]|1|  
|If \(showed up with Address2\) \[apparu avec Address2\]|Rounding \[arrondi\]|1|  
|If \(RoundRobin1\)|Regular \[normale\]|0|  
|If \(RoundRobin2\)|Rounding \[arrondi\]|0|  
...
2.  Pour ouvrir l'**Explorateur de solutions**, sélectionnez **Explorateur de solutions** dans le menu **Affichage**.  
...
9. Dans la fenêtre de console du client, tapez `quit` et appuyez sur ENTRÉE pour quitter.  
