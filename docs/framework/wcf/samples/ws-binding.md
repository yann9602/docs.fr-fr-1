...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Liaison HTTP de WS 2007 Federation](../../../../docs/framework/wcf/samples/ws-2007-federation-http-binding.md)  
 Illustre l'utilisation de <xref:System.ServiceModel.WS2007FederationHttpBinding>.  
  
 [WS double Http](../../../../docs/framework/wcf/samples/ws-dual-http.md)  
 ...
 [Transport WS avec les informations d’identification de Message](../../../../docs/framework/wcf/samples/ws-transport-with-message-credential.md)  
