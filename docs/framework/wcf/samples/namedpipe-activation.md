...
Cet exemple illustre l'hébergement d'un service qui utilise le service d'activation des processus Windows \(WAS\) pour activer un service qui communique sur des canaux nommés.  Cet exemple est basé sur [Getting Started](../../../../docs/framework/wcf/samples/getting-started-sample.md) et requiert l'exécution de [!INCLUDE[wv](../../../../includes/wv-md.md)].  
...
>   
>  `<LecteurInstall>:\WF_WCF_Samples\WCF\Basic\Services\Hosting\WASHost\NamedPipeActivation`  
