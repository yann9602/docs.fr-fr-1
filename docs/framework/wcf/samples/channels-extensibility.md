...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Profil de sécurité fiable](../../../../docs/framework/wcf/samples/reliable-secure-profile.md)  
 Montre comment agencer [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] et Reliable Secure Profile (RSP).  
  
 [Répartiteur de canal personnalisé](../../../../docs/framework/wcf/samples/custom-channel-dispatcher.md)  
 ...
 [Canal d’accusé de réception HTTP](../../../../docs/framework/wcf/samples/http-acknowledgement-channel.md)  
 ...
 [Intercepteur de Message personnalisé](../../../../docs/framework/wcf/samples/custom-message-interceptor.md)  
