---
title: "Exemple Discovery Binding Element | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Exemple Discovery Binding Element
...
-   **CalculatorService** : un service [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] détectable.  
  
-   **CalculatorClient** : une application cliente [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] qui utilise le canal client de découverte pour rechercher et appeler le CalculatorService.  
  
-   **DynamicCalculatorClient** : une application cliente [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] qui utilise un point de terminaison dynamique pour rechercher et appeler le CalculatorService.  
...
>   
>  `<LecteurInstall>:\WF_WCF_Samples\WCF\Basic\Discovery\DiscoveryBindingElement`  
