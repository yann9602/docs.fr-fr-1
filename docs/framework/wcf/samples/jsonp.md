...
>   
>  `<LecteurInstall>:\WF_WCF_Samples\WCF\Basic\AJAX\JSONP`  
...
3.  Notez qu'une fois la page chargée, des valeurs viennent renseigner les zones de texte « Name » et « Address ».  Ces valeurs ont été fournies à partir d'un appel au service [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] alors que le navigateur avait effectué le rendu de la page.