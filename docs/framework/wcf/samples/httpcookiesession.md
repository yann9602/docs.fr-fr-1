...
>   
>  `<LecteurInstall>:\WF_WCF_Samples\WCF\Extensibility\Channels\HttpCookieSession`  
  
## Modèle d'échange de messages de canal HttpCookieSession  
...
## Ajout du canal au système de configuration  
...
### Section d'extension de l'élément de liaison  
...
4.  Pour exécuter l'exemple dans une configuration à un ou plusieurs ordinateurs, suivez les instructions indiquées dans la rubrique [Exécution des exemples Windows Communication Foundation](../../../../docs/framework/wcf/samples/running-the-samples.md).  
