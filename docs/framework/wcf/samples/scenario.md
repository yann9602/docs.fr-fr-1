...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Sérialisation de weakly-typed JSON (AJAX)](../../../../docs/framework/wcf/samples/weakly-typed-json-serialization-sample.md)  
 ...
 [Service de façade approuvé](../../../../docs/framework/wcf/samples/trusted-facade-service.md)  
 ...
 [Design Patterns : List-Based publication-abonnement](../../../../docs/framework/wcf/samples/design-patterns-list-based-publish-subscribe.md)  
