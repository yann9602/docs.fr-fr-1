...
## Le fichier de commandes d'installation  
...
-   Création du certificat de serveur  
     ...
     Les lignes suivantes du fichier de commandes Setup.bat créent le certificat de serveur à utiliser.La variable %SERVER\_NAME% spécifie le nom du serveur.Modifiez cette variable pour spécifier votre propre nom de serveur.Ce fichier de commandes a comme valeur par défaut « localhost ».  
