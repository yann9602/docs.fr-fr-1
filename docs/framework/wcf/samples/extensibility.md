...
Cette section contient des exemples qui traitent de l'extensibilité personnalisée et d'autres fonctionnalités de [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Instanciation d’extensibilité](../../../../docs/framework/wcf/samples/instancing-extensibility.md)  
 ...
 [Extensibilité d’encodeur de message](../../../../docs/framework/wcf/samples/message-encoder-extensibility.md)  
 ...
 [Exemples d’extensibilité de syndication](../../../../docs/framework/wcf/samples/syndication-extensibility-samples.md)  
 ...
 [Formateur d’opération et le sélecteur d’opération](../../../../docs/framework/wcf/samples/operation-formatter-and-operation-selector.md)  
 ...
 Montre comment remplacer les filtres de message que [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] utilise pour distribuer des messages aux points de terminaison.  
 ...
 [Extension du contrôle à la gestion des erreurs et création de rapports](../../../../docs/framework/wcf/samples/extending-control-over-error-handling-and-reporting.md)  
 ...
 [Inspecteurs de message](../../../../docs/framework/wcf/samples/message-inspectors.md)  
