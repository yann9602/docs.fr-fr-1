---
title: "H&#233;bergement de services | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
#### Windows Process Activation Service \(WAS\)  
 ...
 Cette option d'hébergement requiert que les services WAS soient configurés correctement, mais n'exige pas l'écriture d'un code d'hébergement dans le cadre de l'application.[!INCLUDE[crabout](../../../includes/crabout-md.md)] la configuration de l’hébergement WAS, consultez [Comment : héberger un service WCF dans WAS](../../../docs/framework/wcf/feature-details/how-to-host-a-wcf-service-in-was.md).  
...
|---------------------------------|------------------------|-----------------------------------|  
|Application managée \(« auto\-hébergée »\)|-   Applications consoles utilisées pendant le développement.<br />-   Applications clientes [!INCLUDE[avalon2](../../../includes/avalon2-md.md)] et WinForm élaborées accédant aux services.|-   Souple.<br />-   Facile à déployer.<br />-   Ne constitue pas une solution d'entreprise pour les services.|  
|Services Windows \(autrefois appelés services NT\)|-   Service [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] de longue durée hébergé en dehors d'IIS.|-   Durée de vie des processus de service contrôlée par le système d'exploitation, non pas activée par des messages.<br />-   Pris en charge par toutes les versions de Windows.<br />-   Environnement sécurisé.|  
|IIS 5.1, [!INCLUDE[iis601](../../../includes/iis601-md.md)]|-   Exécution d'un service [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] côte à côte avec un contenu [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] sur Internet à l'aide du protocole HTTP.|-   Recyclage de processus.<br />-   Arrêt inactif.<br />-   Contrôle d'état de processus.<br />-   Activation basée sur des messages.<br />-   HTTP uniquement.|  
|Windows Process Activation Service \(WAS\)|-   Exécution d'un service [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] sur Internet sans installer IIS qui utilise différents protocoles de transport.|-   IIS n'est pas requis.<br />-   Recyclage de processus.<br />-   Arrêt inactif.<br />-   Contrôle d'état de processus.<br />-   Activation basée sur des messages.<br />-   Fonctionne avec HTTP, TCP, les canaux nommés et MSMQ.|  
|IIS 7,0|-   Exécution d'un service [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] avec du contenu [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)].<br />-   Exécution d'un service [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] sur Internet qui utilise différents protocoles de transport.|-   Avantages du service WAS.<br />-   Intégré avec du contenu [!INCLUDE[vstecasp](../../../includes/vstecasp-md.md)] et IIS.|  
