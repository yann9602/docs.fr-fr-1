...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Encodeurs personnalisés](../../../../docs/framework/wcf/extending/custom-encoders.md)  
 Décrit le rôle que les encodeurs de message jouent dans les canaux et comment en générer un.  
  
 [Mises à niveau de flux de données personnalisé](../../../../docs/framework/wcf/extending/custom-stream-upgrades.md)  
