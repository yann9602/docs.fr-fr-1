---
title: "Comment&#160;: utiliser des certificats X.509 distincts pour les signatures et le chiffrement | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   `MyClientCredentialsSecurityTokenManager` est une implémentation personnalisée de <xref:System.ServiceModel.ClientCredentialsSecurityTokenManager>.  
 ...
 ![Graphique indiquant l'utilisation des informations d'identification du client](../../../../docs/framework/wcf/extending/media/e4971edd-a59f-4571-b36f-7e6b2f0d610f.gif "e4971edd\-a59f\-4571\-b36f\-7e6b2f0d610f")  
  
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] les informations d'identification personnalisées, consultez [Procédure pas à pas : création d'informations d'identification de client et de service personnalisées](../../../../docs/framework/wcf/extending/walkthrough-creating-custom-client-and-service-credentials.md).  
 ...
 ![Graphique indiquant un élément de liaison personnalisé](../../../../docs/framework/wcf/extending/media/dddea4a2-0bb4-4921-9bf4-20d4d82c3da5.gif "dddea4a2\-0bb4\-4921\-9bf4\-20d4d82c3da5")  
  
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] la création d'un vérificateur d'identité personnalisé, consultez Comment : [Comment : créer un vérificateur d'identité du client personnalisé](../../../../docs/framework/wcf/extending/how-to-create-a-custom-client-identity-verifier.md).  
