---
title: "Envoi et r&#233;ception des erreurs | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
> [!NOTE]
>  Lorsqu'un service [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] a la propriété <xref:System.ServiceModel.ServiceBehaviorAttribute.IncludeExceptionDetailInFaults%2A?displayProperty=fullName> ou <xref:System.ServiceModel.Description.ServiceDebugBehavior.IncludeExceptionDetailInFaults%2A?displayProperty=fullName> définie à `true`, le client subit l'erreur en tant que <xref:System.ServiceModel.FaultException%601> non déclarée de type <xref:System.ServiceModel.ExceptionDetail>.Les clients peuvent intercepter cette erreur spécifique ou gérer l'erreur dans un bloc catch pour <xref:System.ServiceModel.FaultException>.  
...
> [!NOTE]
>  D'autres exceptions, bien sûr, se produisent.Les exceptions inattendues incluent des défaillances catastrophiques telles que <xref:System.OutOfMemoryException?displayProperty=fullName> ; en général, les applications ne doivent pas intercepter de telles méthodes.  
...
-   Lorsque l'application cliente appelle <xref:System.ServiceModel.ClientBase%601.Close%2A?displayProperty=fullName>.  
  
-   Lorsque l'application cliente appelle <xref:System.ServiceModel.ICommunicationObject.Close%2A?displayProperty=fullName>.  
...
> [!NOTE]
>  Cet exemple de code n'utilise pas la construction `using`.La fermeture des canaux pouvant lever des exceptions, il est recommandé que les applications créent tout d'abord un client [!INCLUDE[indigo2](../../../includes/indigo2-md.md)], puis ouvrent, utilisent et ferment le client [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] dans le même bloc try.Pour plus d'informations, consultez [Vue d'ensemble d'un client WCF](../../../docs/framework/wcf/wcf-client-overview.md) et [Avoiding Problems with the Using Statement](../../../docs/framework/wcf/samples/avoiding-problems-with-the-using-statement.md).  
