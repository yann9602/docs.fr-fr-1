---
title: "Interop&#233;rabilit&#233; avec les applications POX | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Programmation POX avec WCF  
 Les services [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] qui communiquent par HTTP à l'aide de messages POX utilisent une [\<customBinding\>](../../../../docs/framework/configure-apps/file-schema/wcf/custombinding.md).  
