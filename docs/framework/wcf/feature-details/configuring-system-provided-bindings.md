---
title: "Configuration des liaisons fournies par le syst&#232;me | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "WCF (WCF), liaisons fournies par le système"
  - "Windows Communication Foundation (WCF), liaisons fournies par le système"
...
|-------------|----------------------|--------------------------------------------|-----------------------------|------------------|------------|  
|<xref:System.ServiceModel.BasicHttpBinding>|Basic Profile 1.1|\(Aucun\), transport, message, mixte|Aucun, \(aucun\)|\(Aucun\)|Non applicable|  
|<xref:System.ServiceModel.WSHttpBinding>|WS|Aucun, transport, \(message\), mixte|\(Aucun\), transport, session fiable|\(Aucun\), oui|Non applicable|  
|<xref:System.ServiceModel.WS2007HttpBinding>|WS\-Security, WS\-Trust, WS\-SecureConversation, WS\-SecurityPolicy|Aucun, transport, \(message\), mixte|\(Aucun\), transport, session fiable|\(Aucun\), oui|Non applicable|  
