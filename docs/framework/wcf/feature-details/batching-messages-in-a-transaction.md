---
title: "Traitement par lots des messages dans une transaction | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "traitement par lots des messages (WCF)"
...
-   `TransactionScopeRequired`.Lors du traitement d'un lot de messages, si [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] en trouve un qui a `TransactionScopeRequired`  \= `false`, il valide le lot et en rouvre un nouveau sur la réception du premier message avec `TransactionScopeRequired` \= `true` et `TransactionAutoComplete` \= `true`.  
...
## Conservation du mode de traitement par lot  
