---
title: "Combinaison de protocoles d&#39;approbation dans les sc&#233;narios f&#233;d&#233;r&#233;s | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Combinaison de protocoles d&#39;approbation dans les sc&#233;narios f&#233;d&#233;r&#233;s
...
## RP février 2005 et STS février 2005  
...
## Version d'approbation RP 1.3 et Version d'approbation STS 1.3  
 Le WSDL pour la partie de confiance \(RP\) contient les éléments suivants dans la section `RequestSecurityTokenTemplate` :  
...
## Version d'approbation RP février 2005 et Version d'approbation STS 1.3  
 Le WSDL pour la partie de confiance \(RP\) contient les éléments suivants dans la section `RequestSecurityTokenTemplate` :  
...
## Version d'approbation RP 1.3 et Version d'approbation STS février 2005  
 Le WSDL pour la partie de confiance \(RP\) contient les éléments suivants dans la section `RequestSecurityTokenTemplate` :  
