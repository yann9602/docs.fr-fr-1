---
title: "Refus de service | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Risque de saturation du journal des événements d'audit  
 ...
 Pour minimiser ce problème, affectez à la propriété <xref:System.ServiceModel.Description.ServiceSecurityAuditBehavior.SuppressAuditFailure%2A> la valeur `true` et utilisez les propriétés de l'Observateur d'événements pour contrôler le comportement d'audit.  [!INCLUDE[crabout](../../../../includes/crabout-md.md)] l'utilisation de l'Observateur d'événements pour afficher et gérer les journaux d'événements, consultez [Observateur d'événements](http://go.microsoft.com/fwlink/?LinkId=186123).  [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [Audit](../../../../docs/framework/wcf/feature-details/auditing-security-events.md).  
  
## Une implémentation non valide de la stratégie IAuthorizationPolicy peut provoquer le blocage du service  
...
## L'inscription automatique provoque la création de plusieurs certificats avec le même nom de sujet pour l'ordinateur  
 ...
 Pour atténuer ce risque, référencez le certificat exact à utiliser en appliquant un critère de recherche plus précis sur [\<serviceCredentials\>](../../../../docs/framework/configure-apps/file-schema/wcf/servicecredentials.md).  Par exemple, utilisez l'option <xref:System.Security.Cryptography.X509Certificates.X509FindType> et spécifiez le certificat par son empreinte numérique unique \(hachage\).  
