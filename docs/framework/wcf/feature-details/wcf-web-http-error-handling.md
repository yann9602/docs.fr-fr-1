---
title: "Gestion des erreurs HTTP Web WCF | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   la valeur de la propriété <xref:System.ServiceModel.Web.OutgoingWebResponseContext.Format%2A> en accédant à l'objet <xref:System.ServiceModel.Web.OutgoingWebResponseContext>.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)] comment ces valeurs affectent la mise en forme de l'opération, consultez [Mise en forme HTTP Web WCF](../../../../docs/framework/wcf/feature-details/wcf-web-http-formatting.md).  
