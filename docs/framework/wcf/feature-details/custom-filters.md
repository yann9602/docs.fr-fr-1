...
> [!NOTE]
>  Dans une implémentation réelle, les méthodes de correspondance contient la logique qui examine le message pour déterminer si ce filtre de messages doit retourner **true** ou **false**.  
