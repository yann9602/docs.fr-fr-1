...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Comment : sérialiser et désérialiser des données JSON](../../../../docs/framework/wcf/feature-details/how-to-serialize-and-deserialize-json-data.md)  
 ...
 Décrit la correspondance entre les encodages JSON (JavaScript Object Notation) et les ensembles d'informations XML, utilisés en interne par [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] pour représenter des données et des documents encodés JSON.  
