...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit certaines considérations relatives à la sécurité des clients [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
  
## <a name="see-also"></a>Voir aussi  
 [Exemples de clients](http://msdn.microsoft.com/library/849fc452-8718-4d4e-ba57-905eed943f63)
