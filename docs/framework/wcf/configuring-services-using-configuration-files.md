---
title: "Configuration des services &#224; l&#39;aide de fichiers de configuration | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   [\<endpoint\> element reference](http://msdn.microsoft.com/fr-fr/13aa23b7-2f08-4add-8dbf-a99f8127c017)  
...
### Élément \<binding\>  
 Les éléments `binding` contenus dans l'élément `bindings` peuvent être une des liaisons fournies par le système \(consultez [Liaisons fournies par le système](../../../docs/framework/wcf/system-provided-bindings.md)\) ou une liaison personnalisée \(consultez [Liaisons personnalisées](../../../docs/framework/wcf/extending/custom-bindings.md)\). L'élément `binding` a un attribut `name` qui correspond la liaison avec le point de terminaison spécifié dans l'attribut `bindingConfiguration` de l'élément `endpoint`. Si aucun nom n'est spécifié, cette liaison correspond à la valeur par défaut de ce type de liaison.  
  
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] la configuration des services et des clients, consultez [Configuring Windows Communication Foundation Applications](http://msdn.microsoft.com/fr-fr/13cb368e-88d4-4c61-8eed-2af0361c6d7a).  
...
## Voir aussi  
 ...
 [Configuring Windows Communication Foundation Applications](http://msdn.microsoft.com/fr-fr/13cb368e-88d4-4c61-8eed-2af0361c6d7a)   
 [\<service\>](../../../docs/framework/configure-apps/file-schema/wcf/service.md)   
 [\<liaison\>](../../../docs/framework/misc/binding.md)