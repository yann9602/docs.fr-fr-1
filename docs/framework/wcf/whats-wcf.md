---
title: "Pr&#233;sentation de Windows Communication Foundation | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Windows Communication Foundation [WCF], vue d’ensemble de la technologie"
  - "vue d'ensemble de la technologie (WCF)"
  - "WCF [WCF], vue d’ensemble de la technologie"
...
## Fonctions de WCF  
 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] comprend l'ensemble de fonctionnalités suivant.[!INCLUDE[crdefault](../../../includes/crdefault-md.md)] [Informations détaillées sur les fonctionnalités de WCF](../../../docs/framework/wcf/feature-details/index.md).  
