...
---
# <a name="reliable-messaging-messages-dropped"></a>Messages de messagerie fiable déposés
Nom du compteur : Sessions de messagerie fiable déposées.  
  
## <a name="description"></a>Description  
 Nombre total de messages de messagerie fiable qui ont été déposés dans ce service.
