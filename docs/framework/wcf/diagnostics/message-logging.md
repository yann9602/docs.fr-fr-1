...
## <a name="in-this-section"></a>Dans cette section  
 [Vue d’ensemble du flux de message](../../../../docs/framework/wcf/diagnostics/message-flow-overview.md)  
 ...
 [Problèmes de sécurité pour la journalisation des messages](../../../../docs/framework/wcf/diagnostics/security-concerns-for-message-logging.md)  
