...
#### [Scénarios synchrones utilisant HTTP, TCP ou un canal nommé](synchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Scénarios asynchrones utilisant HTTP, TCP ou un canal nommé](asynchronous-scenarios-using-http-tcp-or-named-pipe.md)
...
## [Paramètres recommandés pour le suivi et la journalisation des messages](recommended-settings-for-tracing-and-message-logging.md)
## [Problèmes de sécurité et conseils utiles pour le suivi](security-concerns-and-useful-tips-for-tracing.md)
## [Informations de référence sur les suivis](traces-reference.md)
