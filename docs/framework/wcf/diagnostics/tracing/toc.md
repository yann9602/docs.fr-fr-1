...
### [Transfert](transfer.md)
### [Propagation](propagation.md)
### [Résumé des types de trace](trace-type-summary.md)
## [Utilisation du suivi pour dépanner votre Application](using-tracing-to-troubleshoot-your-application.md)
...
#### [Scénarios asynchrones à l’aide de HTTP, TCP ou canal nommé](asynchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Suivi des activités de sécurité des messages](activity-tracing-in-message-security.md)
#### [MSMQ](msmq.md)
#### [COM +](com.md)
### [Suivis principaux](significant-traces.md)
### [Débogage sur le Client](debugging-on-the-client.md)
### [L’émission de Traces de Code utilisateur](emitting-user-code-traces.md)
## [Paramètres recommandés pour le traçage et journalisation des messages](recommended-settings-for-tracing-and-message-logging.md)
## [Problèmes de sécurité et des conseils utiles pour le suivi](security-concerns-and-useful-tips-for-tracing.md)
