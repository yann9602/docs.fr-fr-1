...
## <a name="description"></a>Description  
 Cette trace est émise lors de la construction d'un hôte de service, au niveau Informations. Elle fournit une description du contrat de service et de la liaison.  
