...
manager: wpickett
ms.openlocfilehash: 5db3563f626d4344df03cfe1598a923607424c06
...
PeerNode a commencé à s'initialiser.  
  
## <a name="description"></a>Description  
 Ce suivi se produit au début de l'exécution du code d'initialisation (Open) de PeerNode.  
