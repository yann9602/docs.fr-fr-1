...
## <a name="description"></a>Description  
 Ce suivi de niveau d'avertissement indique qu'une réponse de canal HTTP a été annulée. Les informations supplémentaires du suivi indiquent la raison ou le message passé à la méthode d'annulation.  
