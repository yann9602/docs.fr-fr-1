...
Service de protocole WS-Atomic Transaction correctement inscrit sur une transaction qui utilise le contexte de coordination fourni.  
  
## <a name="description"></a>Description  
 Une transaction entrante a été correctement traitée.  
