...
## <a name="description"></a>Description  
 Cet événement est émis lorsque l'annulation de l'inscription de la file des messages a réussi.  
  
## <a name="message"></a>Message  
 Désinscription de la file d'attente des messages effectuée pour l'URI : « %1 ».  
