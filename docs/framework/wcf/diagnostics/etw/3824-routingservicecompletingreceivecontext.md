...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le service de routage appelle ReceiveContext.Complete pour un message avec un ID spécifié.  
  
## <a name="message"></a>Message  
 Le service de routage appelle ReceiveContext.Complete pour le message avec l'ID « %1 ».  
