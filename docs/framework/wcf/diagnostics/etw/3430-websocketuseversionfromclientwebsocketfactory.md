...
## <a name="description"></a>Description  
 Cet événement est émis lors de l'utilisation du WebSocketVersion d'une fabrique WebSocket cliente.  
  
## <a name="message"></a>Message  
 Utilisation du WebSocketVersion d'une fabrique WebSocket cliente de type « %1 ».  
