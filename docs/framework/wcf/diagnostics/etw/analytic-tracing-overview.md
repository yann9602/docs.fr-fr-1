---
title: "Vue d&#39;ensemble du tra&#231;age analytique | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "traçage analytique [WCF], vue d’ensemble"
...
---
# Vue d&#39;ensemble du tra&#231;age analytique
...
### Activation des paramètres de diagnostic WCF  
...
### Suivi de flux de messages  
 [!INCLUDE[crabout](../../../../../includes/crabout-md.md)] la manière d’activer le suivi de flux de messages, consultez [Configuration du suivi de flux de messages](../../../../../docs/framework/wcf/diagnostics/etw/configuring-message-flow-tracing.md).  
