...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le message en sortie de fermeture WebSocket est envoyé.  
  
## <a name="message"></a>Message  
 L'élément WebSocketId %1 a envoyé un message en sortie de fermeture à « %2 » avec l'état de fermeture « %3 ».  
