...
## <a name="description"></a>Description  
 Cet événement est émis lorsque WindowsStreamSecurity initialise la mise à niveau de sécurité.  
  
## <a name="message"></a>Message  
 Début de la mise à niveau de sécurité par WindowsStreamSecurity.  
