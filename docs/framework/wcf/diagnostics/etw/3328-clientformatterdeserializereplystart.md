...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le client commence la désérialisation du message de réponse.  
  
## <a name="message"></a>Message  
 Le client a démarré la désérialisation du message de réponse.  
