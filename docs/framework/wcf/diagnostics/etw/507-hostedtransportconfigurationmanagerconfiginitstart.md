...
## <a name="description"></a>Description  
 Cet événement est émis lorsque l'initialisation de HostedTransportConfigurationManager commence.  
  
## <a name="message"></a>Message  
 Initialisation du début de la configuration HostedTransportConfigurationManager.  
