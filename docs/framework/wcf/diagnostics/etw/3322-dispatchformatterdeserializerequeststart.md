...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le répartiteur a commencé la désérialisation du message de demande.  
  
## <a name="message"></a>Message  
 Le répartiteur a démarré la désérialisation du message de requête.  
