...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le paramétrage du principal à partir du jeton de session a réussi.  
  
## <a name="message"></a>Message  
 Paramétrage du principal à partir du jeton de session effectué.  
