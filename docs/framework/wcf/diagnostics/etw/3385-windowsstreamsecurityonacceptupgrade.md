...
## <a name="description"></a>Description  
 Cet événement est émis sur la sécurité de flux Windows acceptant la mise à niveau de sécurité.  
  
## <a name="message"></a>Message  
 Sécurité Windows relative à la diffusion en continu après acceptation de la mise à niveau.  
