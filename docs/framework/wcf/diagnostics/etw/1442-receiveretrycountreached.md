...
## <a name="description"></a>Description  
 Cet événement est émis lorsque le nombre maximal de nouvelles tentatives est atteint sur un message MSMQ.  
  
## <a name="message"></a>Message  
 Nombre de tentatives de réceptions atteint dans le message MSMQ avec l'ID « %1 »  
