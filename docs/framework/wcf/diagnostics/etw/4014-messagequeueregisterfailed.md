...
## <a name="description"></a>Description  
 Cet événement est émis lorsque l'inscription à la file des messages a échoué.  
  
## <a name="message"></a>Message  
 Échec de l'inscription à la file d'attente des messages pour l'URI « %1 » avec l'état « %2 ».  
