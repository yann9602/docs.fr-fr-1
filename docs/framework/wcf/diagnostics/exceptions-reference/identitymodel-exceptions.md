---
title: "Exceptions IdentityModel | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|SAMLUnableToLoadAdvice|Échec du chargement de l'élément \<saml:advice\>.|  
...
|SspiWrapperEncryptDecryptAssert2|SSPIWrapper::EncryptDecryptHelper&#124;'size' est hors limites.SecurityTokenManagerCannotCreateAuthenticatorForRequirement\=Le gestionnaire de jetons de sécurité ne peut pas créer d'authentificateur de jeton pour la condition spécifique.|  
...
|SAMLUnableToLoadAssertion|Échec du chargement de l'élément \<saml:assertion\>.|  
...
|SAMLUnableToLoadCondtions|Échec du chargement de l'élément \<saml:conditions\>.|  
...
|SAMLUnableToLoadCondtion|Échec du chargement de l'élément \<saml:conditions\>.|  
...
|TraceCodeSecurityClientSessionCloseSent|Un message de fermeture a été envoyé par la session de sécurité du client.|  
...
|IncorrectUserNameFormat|Le format du nom d'utilisateur est non valide.Il doit prendre l'une des formes suivantes : 'NomUtilisateur' ou 'Domaine\\\\'NomUtilisateur'.|  
