---
title: "Outil de configuration de mod&#232;le de service COM+ (ComSvcConfig.exe) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  Vous devez être administrateur sur l'ordinateur local pour pouvoir utiliser ComSvcConfig.exe.  
 ...
 Pour plus d'informations sur ComSvcConfig.exe, consultez [Comment : utiliser l'outil de configuration de modèle de service COM\+](../../../docs/framework/wcf/feature-details/how-to-use-the-com-service-model-configuration-tool.md).  
