---
title: "Meilleures pratiques&#160;: contr&#244;le de version des contrats de donn&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "meilleures pratiques (WCF), contrôle de version des contrats de données"
  - "Contrats de données"
  - "contrats de service"
  - "Windows Communication Foundation, Contrats de données"
...
Cette rubrique répertorie les méthodes conseillées pour créer des contrats de données qui peuvent évoluer facilement avec le temps.  [!INCLUDE[crabout](../../../includes/crabout-md.md)] les contrats de données, consultez les rubriques répertoriées dans [Utilisation de contrats de données](../../../docs/framework/wcf/feature-details/using-data-contracts.md).  
  
## Note sur la validation de schéma  
...
## Contrôle de version lorsque la validation de schéma est requise  
 ...
 [!INCLUDE[crdefault](../../../includes/crdefault-md.md)] Méthodes conseillées : [Contrôle de version des services](../../../docs/framework/wcf/service-versioning.md).  
...
-   Appliquez un attribut <xref:System.ServiceModel.ServiceBehaviorAttribute> à votre contrat de service en affectant à la propriété <xref:System.ServiceModel.ServiceBehaviorAttribute.IgnoreExtensionDataObject%2A> la valeur `true`.  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] sur l'aller\-retour, consultez [Contrats de données à compatibilité ascendante](../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md).  
  
## Contrôle de version lorsque la validation de schéma n'est pas requise  
 La conformité stricte de schéma est rarement requise.  De nombreuses plateformes tolèrent des éléments supplémentaires non décrits par un schéma.  Tant que cela est toléré, le jeu complet de fonctionnalités décrit dans [Contrôle de version des contrats de données](../../../docs/framework/wcf/feature-details/data-contract-versioning.md) et [Contrats de données à compatibilité ascendante](../../../docs/framework/wcf/feature-details/forward-compatible-data-contracts.md) peut être utilisé.  Les instructions suivantes sont recommandées.  
