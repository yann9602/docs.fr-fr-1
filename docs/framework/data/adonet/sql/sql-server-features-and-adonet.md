...
## <a name="in-this-section"></a>Dans cette section  
 [L’énumération des Instances de SQL Server (ADO.NET)](../../../../../docs/framework/data/adonet/sql/enumerating-instances-of-sql-server.md)  
 ...
 [Base de données mise en miroir dans SQL Server](../../../../../docs/framework/data/adonet/sql/database-mirroring-in-sql-server.md)  
 ...
 [Isolement d’instantané dans SQL Server](../../../../../docs/framework/data/adonet/sql/snapshot-isolation-in-sql-server.md)  
 ...
 [Prise en charge de SqlClient pour la haute disponibilité, la récupération d’urgence](../../../../../docs/framework/data/adonet/sql/sqlclient-support-for-high-availability-disaster-recovery.md)  
