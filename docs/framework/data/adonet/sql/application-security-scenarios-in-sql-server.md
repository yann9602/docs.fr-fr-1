---
title: "Sc&#233;narios de s&#233;curit&#233; des applications dans SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Sc&#233;narios de s&#233;curit&#233; des applications dans SQL Server
...
## Dans cette section  
 ...
 [Octroi d'autorisations de niveau ligne dans SQL Server](../../../../../docs/framework/data/adonet/sql/granting-row-level-permissions-in-sql-server.md)  
 ...
 [Activation de l'accès aux bases de données croisées dans SQL Server](../../../../../docs/framework/data/adonet/sql/enabling-cross-database-access-in-sql-server.md)  
