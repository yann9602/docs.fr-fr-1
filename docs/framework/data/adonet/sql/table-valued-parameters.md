---
title: "Param&#232;tres table | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|---------------|-----------------|  
|[Paramètres table \(Moteur de base de données\)](http://go.microsoft.com/fwlink/?LinkId=98363) dans la documentation en ligne de [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)]|Décrit comment créer et utiliser des paramètres table.|  
|[Types de tables définis par l'utilisateur](http://go.microsoft.com/fwlink/?LinkId=98364) dans la documentation en ligne de [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)]|Décrit les types de tables définis par l'utilisateur qui permettent de déclarer des paramètres table.|  
|La section [Moteur de base de données Microsoft SQL Server](http://go.microsoft.com/fwlink/?LinkId=120507) de [CodePlex](http://go.microsoft.com/fwlink/?LinkID=67739)|Contient des exemples qui montrent comment utiliser les fonctions et fonctionnalités de [!INCLUDE[ssNoVersion](../../../../../includes/ssnoversion-md.md)].|  
...
-   Vous ne pouvez pas passer des paramètres table à des [fonctions CLR définies par l'utilisateur](http://msdn.microsoft.com/library/ms131077.aspx).  
...
> [!NOTE]
>  Si vous indiquez une valeur pour une colonne d'identité d'un paramètre table, vous devez émettre l'instruction SET IDENTITY\_INSERT pour la session.  
