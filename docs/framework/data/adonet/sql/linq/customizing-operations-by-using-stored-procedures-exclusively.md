---
title: "Personnalisation d&#39;op&#233;rations &#224; l&#39;aide de proc&#233;dures stock&#233;es uniquement | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Personnalisation d&#39;op&#233;rations &#224; l&#39;aide de proc&#233;dures stock&#233;es uniquement
L'accès aux données se fait couramment à l'aide de procédures stockées uniquement.  
  
## Exemple  
  
### Description  
 Vous pouvez modifier l'exemple fourni dans [Personnalisation d'opérations à l'aide de procédures stockées](../../../../../../docs/framework/data/adonet/sql/linq/customizing-operations-by-using-stored-procedures.md) en remplaçant la première requête \(qui entraîne une exécution SQL dynamique\) par un appel de méthode qui encapsule une procédure stockée.  
