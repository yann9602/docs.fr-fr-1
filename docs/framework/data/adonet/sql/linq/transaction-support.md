...
## <a name="see-also"></a>Voir aussi  
 ...
 [Comment : mettre entre les envois de données à l’aide de Transactions](../../../../../../docs/framework/data/adonet/sql/linq/how-to-bracket-data-submissions-by-using-transactions.md)
