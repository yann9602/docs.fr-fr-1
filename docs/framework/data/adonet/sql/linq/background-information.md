---
title: "Informations g&#233;n&#233;rales | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   Participez au [forum LINQ](http://go.microsoft.com/fwlink/?LinkId=76488), où vous pourrez aborder des sujets plus complexes avec des experts.  
  
-   Étudiez le livre blanc qui présente en détail la technologie [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)], ainsi que des exemples de code [!INCLUDE[vbprvb](../../../../../../includes/vbprvb-md.md)] et C\#.  Pour plus d'informations, consultez [LINQ to SQL : LINQ \(Language\-Integrated Query\) .NET pour les données relationnelles](http://go.microsoft.com/fwlink/?LinkId=93205).  
