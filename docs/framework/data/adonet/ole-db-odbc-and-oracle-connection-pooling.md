---
title: "Regroupement de connexions OLE&#160;DB, ODBC et Oracle | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Regroupement de connexions pour OleDb  
...
```  
 ...
 Pour plus d'informations sur le regroupement de sessions ou de ressources OLE DB, ainsi que sur la désactivation du regroupement par remplacement des valeurs par défaut du service du fournisseur OLE DB, consultez le [Guide du programmeur OLE DB](http://go.microsoft.com/fwlink/?linkid=45232) dans la bibliothèque MSDN.  
  
## Regroupement de connexions pour Odbc  
 ...
 Pour activer ou désactiver le regroupement de connexions, ouvrez l'**administrateur de source de données ODBC** que vous trouverez dans le dossier Outils d'administration du Panneau de configuration.  L'onglet **Groupement de connexions** vous permet de spécifier les paramètres du regroupement de connexion pour chaque pilote ODBC installé.  Notez que les modifications apportées au regroupement de connexions d'un pilote ODBC affectent toutes les applications qui utilisent ce pilote.  
  
 Pour plus d'informations sur le regroupement de connexions ODBC, consultez [INFO : Forum Aux Questions sur le regroupement de connexions ODBC](http://support.microsoft.com/kb/169470) dans la bibliothèque MSDN.  
  
## Regroupement de connexions pour OracleClient  
