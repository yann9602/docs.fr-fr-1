---
title: "Cr&#233;ation d&#39;un objet DataView (LINQ to DataSet) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
Il existe deux manières de créer un <xref:System.Data.DataView> dans le contexte de [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)].  Vous pouvez créer un <xref:System.Data.DataView> à partir d'une requête [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)] sur une <xref:System.Data.DataTable>, ou vous pouvez la créer à partir d'une <xref:System.Data.DataTable> typée ou non typée.  Dans les deux cas, vous créez l'objet <xref:System.Data.DataView> en utilisant l'une des méthodes d'extension <xref:System.Data.DataTableExtensions.AsDataView%2A> ; l'objet <xref:System.Data.DataView> ne peut pas être construit directement dans le contexte [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)].  
 ...
 Pour plus d'informations sur le filtrage et le tri avec <xref:System.Data.DataView>, voir [Filtrage avec DataView](../../../../docs/framework/data/adonet/filtering-with-dataview-linq-to-dataset.md) et [Tri avec DataView](../../../../docs/framework/data/adonet/sorting-with-dataview-linq-to-dataset.md).  
...
-   <xref:System.Data.EnumerableRowCollectionExtensions.Where%2A>  
 ...
 Notez que, lorsqu'un objet <xref:System.Data.DataView> est créé à partir d'une requête [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)], la méthode <xref:System.Data.EnumerableRowCollectionExtensions.Select%2A> doit être la dernière méthode appelée dans la requête. Cela est illustré dans l'exemple suivant, qui crée un objet <xref:System.Data.DataView> de commandes en ligne triées par montant total dû :  
...
## Création d'un DataView à partir d'un DataTable  
 Outre d'être créé à partir d'une requête [!INCLUDE[linq_dataset](../../../../includes/linq-dataset-md.md)], un objet <xref:System.Data.DataView> peut être créé à partir d'un objet <xref:System.Data.DataTable> à l'aide de la méthode <xref:System.Data.DataTableExtensions.AsDataView%2A>.  
