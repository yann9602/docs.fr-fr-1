---
title: "Gestion des &#233;v&#233;nements DataAdapter | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|`SkipAllRemainingRows`|Abandonner l'opération de mise à jour mais ne pas lever d'exception.|  
 ...
 L'affectation de la valeur `ErrorsOccurred` à la propriété `Status` entraîne la levée d'une exception.  Vous pouvez contrôler l'exception levée en affectant la propriété `Errors` à l'exception souhaitée.  L'utilisation de l'une des autres valeurs pour `Status` évite la levée d'une exception.  
