---
title: "Objets DataSet, DataTable et DataView | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   Charger et rendre persistent le contenu de l'objet <xref:System.Data.DataSet> à l'aide de XML.  Pour plus d'informations, consultez [Utilisation de XML dans un DataSet](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/using-xml-in-a-dataset.md).  
 ...
 Un objet <xref:System.Data.DataSet> fortement typé peut aussi être transporté au moyen d'un service Web XML.  Le design de l'objet <xref:System.Data.DataSet> le rend idéal pour le transport de données à l'aide des services Web XML.  Pour une vue d'ensemble des services Web XML, voir [XML Web Services Overview](http://msdn.microsoft.com/fr-fr/9db0c7b8-bca6-462b-9be5-f5f9a7f05a4d).  Pour obtenir un exemple d'utilisation d'un objet <xref:System.Data.DataSet> à partir d'un service Web XML, voir [Utilisation d'un DataSet à partir d'un service Web XML](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/consuming-a-dataset-from-an-xml-web-service.md).  
...
## Dans cette section  
 ...
 [Exploration des DataRelations](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/navigating-datarelations.md)  
 ...
 [Copie du contenu d'un DataSet](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/copying-dataset-contents.md)  
 ...
 [Utilisation d'un DataSet à partir d'un service Web XML](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/consuming-a-dataset-from-an-xml-web-service.md)  
...
## Rubriques connexes  
 ...
 Introduit des fonctions nouvelles dans ADO.NET.  
