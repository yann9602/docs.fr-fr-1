---
title: "Mappage de fonctions canoniques de mod&#232;le conceptuel &#224; des fonctions SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|[CreateDateTimeOffset\(year, month, day, hour, minute, second, tzoffset\)](../../../../../docs/framework/data/adonet/ef/language-reference/date-and-time-canonical-functions.md)|Une valeur au format `datetimeoffset` est créée sur le serveur.<br /><br /> Fonction non prise en charge dans SQL Server 2000 et SQL Server 2005.|  
|[CreateTime\(hour, minute, second\)](../../../../../docs/framework/data/adonet/ef/language-reference/date-and-time-canonical-functions.md)|Une valeur au format `time` est créée sur le serveur.<br /><br /> Fonction non prise en charge dans SQL Server 2000 et SQL Server 2005.|  
...
|[Truncate\(expression\)](../../../../../docs/framework/data/adonet/ef/language-reference/date-and-time-canonical-functions.md)|Pour SQL Server 2000 et SQL Server 2005, une valeur au format `datetime` ``  tronquée est créée sur le serveur.  Pour SQL Server 2008 et les versions ultérieures, une valeur `` `datetime2` ou `` `datetimeoffset` est créée sur le serveur.|  
...
|Fonctions canoniques|Fonctions SQL Server|  
|--------------------------|--------------------------|  
|[Abs\(valeur\)](../../../../../docs/framework/data/adonet/ef/language-reference/math-canonical-functions.md)|`ABS(value)`|  
|[Ceiling\(valeur\)](../../../../../docs/framework/data/adonet/ef/language-reference/math-canonical-functions.md)|`CEILING(value)`|  
|[Floor\(valeur\)](../../../../../docs/framework/data/adonet/ef/language-reference/math-canonical-functions.md)|`FLOOR(value)`|  
|[Power\(valeur\)](../../../../../docs/framework/data/adonet/ef/language-reference/math-canonical-functions.md)|`POWER(value, exponent)`|  
|[Round\(valeur\)](../../../../../docs/framework/data/adonet/ef/language-reference/math-canonical-functions.md)|`ROUND(value, digits, 0)`|  
...
|[EndsWith\(string, target\)](../../../../../docs/framework/data/adonet/ef/language-reference/string-canonical-functions.md)|`CHARINDEX(REVERSE(target), REVERSE(string)) = 1`<br /><br /> **Remarque** La fonction `CHARINDEX` retourne `false` si la chaîne `string` est stockée dans une colonne de chaîne de longueur fixe et que `target` est une constante.  Dans ce cas, la chaîne entière est recherchée, y compris les éventuels espaces de remplissage de fin.  Une solution de contournement possible consiste à découper les données dans la chaîne de longueur fixe avant de passer la chaîne à la fonction `EndsWith`, comme dans l'exemple suivant : `EndsWith(TRIM(string), target)`|  
