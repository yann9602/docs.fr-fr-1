---
title: "Proc&#233;dure&#160;: appeler les fonctions de base de donn&#233;es personnalis&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Proc&#233;dure&#160;: appeler les fonctions de base de donn&#233;es personnalis&#233;es
...
2.  Déclarez une fonction dans la partie SSDL \(Store Schema Definition Language\) de votre fichier .edmx.  Le nom de la fonction doit être le même que le nom de la fonction déclarée dans la base de données.  
     ...
     Pour plus d'informations, consultez [Function Element \(SSDL\)](http://msdn.microsoft.com/fr-fr/b60cfc3d-8b93-423e-8c99-b867256640a4).  
...
## Exemple  
 L'exemple suivant montre comment appeler une fonction de base de données personnalisée dans une requête LINQ to Entities.  L'exemple utilise le modèle School.  Pour plus d'informations sur le modèle School, consultez [Creating the School Sample Database](http://msdn.microsoft.com/fr-fr/c1bec483-a0ea-4660-aa0b-7b0a8b68fed0) et [Generating the School .edmx File](http://msdn.microsoft.com/fr-fr/c48b3907-a8be-4fe6-884c-e95af1852758).  
