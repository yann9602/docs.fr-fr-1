---
title: "Exemples de syntaxe d&#39;expression de requ&#234;te&#160;: classement | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Exemples de syntaxe d&#39;expression de requ&#234;te&#160;: classement
Les exemples de cette rubrique montrent comment utiliser les méthodes `OrderBy` et `OrderByDescending` pour interroger le [modèle de vente AdventureWorks Sales Model](http://msdn.microsoft.com/fr-fr/f16cd988-673f-4376-b034-129ca93c7832) à l'aide de la syntaxe d'expression de requête.  Le modèle de vente AdventureWorks Sales Model utilisé dans ces exemples est construit à partir des tables Contact, Address, Product, SalesOrderHeader et SalesOrderDetail de l'exemple de base de données AdventureWorks.  
