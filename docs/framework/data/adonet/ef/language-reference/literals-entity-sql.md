---
title: "Litt&#233;raux (Entity SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## Null  
 ...
 Pour connaître les règles d'utilisation de littéraux Null flottants, voir [Littéraux null et inférence de type](../../../../../../docs/framework/data/adonet/ef/language-reference/null-literals-and-type-inference-entity-sql.md).  
