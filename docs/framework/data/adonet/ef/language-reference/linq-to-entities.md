...
## Conversion de requête  
 ...
 Pour plus d'informations sur la façon dont les appels de méthode CLR sont mappés aux fonctions canoniques dans la source de données, consultez [Mappage de méthodes CLR à des fonctions canoniques](../../../../../../docs/framework/data/adonet/ef/language-reference/clr-method-to-canonical-function-mapping.md).  
  
 Pour plus d'informations sur l'appel de fonctions canoniques, de fonctions de base de données et de fonctions personnalisées depuis des requêtes  [!INCLUDE[linq_entities](../../../../../../includes/linq-entities-md.md)], consultez [Appel de fonctions dans les requêtes LINQ to Entities](../../../../../../docs/framework/data/adonet/ef/language-reference/calling-functions-in-linq-to-entities-queries.md).  
  
## Exécution de la requête  
 Une fois la requête LINQ créée par l'utilisateur, elle est convertie en une représentation compatible avec Entity Framework \(sous la forme d'arborescences de commandes\), qui est ensuite exécutée sur la source de données.  Au moment de l'exécution de la requête, l'ensemble des expressions de requête \(ou des composants de la requête\) sont évalués sur le client ou sur le serveur.  Cela comprend les expressions qui sont utilisées dans la matérialisation des résultats ou les projections d'entités.  Pour plus d'informations, consultez [Exécution de requête](../../../../../../docs/framework/data/adonet/ef/language-reference/query-execution.md).  Pour plus d'informations sur l'amélioration des performances à travers la compilation unique d'une requête et l'exécution multiple de celle\-ci avec des paramètres différents, consultez [Requêtes compilées \(LINQ to Entities\)](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md).  
...
-   Types anonymes.  
 ...
 Pour plus d'informations, consultez [Résultats de requête](../../../../../../docs/framework/data/adonet/ef/language-reference/query-results.md).  
...
## Dans cette section  
 ...
 [Exécution de requête](../../../../../../docs/framework/data/adonet/ef/language-reference/query-execution.md)  
 ...
 [Mappage de méthodes CLR à des fonctions canoniques](../../../../../../docs/framework/data/adonet/ef/language-reference/clr-method-to-canonical-function-mapping.md)  
