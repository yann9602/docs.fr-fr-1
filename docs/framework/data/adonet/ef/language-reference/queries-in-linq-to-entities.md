...
-   [Exemples de syntaxe de requête fondée sur une méthode : groupement](../../../../../../docs/framework/data/adonet/ef/language-reference/method-based-query-syntax-examples-grouping.md)  
