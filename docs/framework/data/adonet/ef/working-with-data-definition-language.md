---
title: "Utilisation du langage de d&#233;finition de donn&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
#### Pour définir une base de données selon le modèle existant  
  
1.  Créez une application console.  
  
2.  Ajoutez un modèle existant à votre application.  
  
    1.  Ajoutez un modèle vide nommé `SchoolModel`.  Pour créer un modèle vide, consultez la rubrique [How to: Create a New .edmx File](http://msdn.microsoft.com/fr-fr/beb8189e-e51c-4051-839c-9902c224abf2).  
  
     Le fichier SchoolModel.edmx est ajouté à votre projet.  
  
    1.  Copiez le contenu conceptuel, de stockage et de mappage pour le modèle School à partir de la rubrique [School Model](http://msdn.microsoft.com/fr-fr/859a9587-81ea-4a45-9bc0-f8d330e1adac).  
