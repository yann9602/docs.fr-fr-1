...
## Extraction de données de la table Oracle  
 Cet exemple utilise un **OracleDataReader** pour accéder aux données et emploie plusieurs structures **OracleType** pour afficher les données.  
