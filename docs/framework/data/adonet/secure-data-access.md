---
title: "Acc&#232;s &#224; des donn&#233;es s&#233;curis&#233;es | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|Ressource|Description|  
|---------------|-----------------|  
|[Paramètres de DataAdapter](../../../../docs/framework/data/adonet/dataadapter-parameters.md)|Décrit comment utiliser des paramètres avec un `DataAdapter`.|  
|[Modification de données à l'aide de procédures stockées\)](../../../../docs/framework/data/adonet/modifying-data-with-stored-procedures.md)|Décrit comment spécifier des paramètres et obtenir une valeur de retour.|  
|[Gestion des autorisations à l'aide des procédures stockées dans SQL Server](../../../../docs/framework/data/adonet/sql/managing-permissions-with-stored-procedures-in-sql-server.md)|Décrit comment utiliser des procédures stockées SQL Server pour encapsuler l'accès aux données.|  
...
|Ressource|Description|  
|---------------|-----------------|  
|[Script Exploits Overview](../Topic/Script%20Exploits%20Overview.md)|Décrit comment se protéger contre des attaques de script et d'instructions SQL.|  
...
## Protection des sources de données Microsoft Access et Excel  
...
|Ressource|Description|  
|---------------|-----------------|  
|[Considérations et directives sur la sécurité pour Access 2007](http://go.microsoft.com/fwlink/?LinkId=98354)|Décrit des techniques de sécurité pour Access 2007, telles que le chiffrement des fichiers, l'administration des mots de passe, la conversion des bases de données vers les nouveaux formats ACCDB et ACCDE, ainsi que l'utilisation d'autres options de sécurité.|  
|[Protéger une base de données Access avec une sécurité de niveau utilisateur \(MDB\)](http://go.microsoft.com/fwlink/?LinkId=47697)|S'applique à Access 2003.  Fournit des instructions permettant d'implémenter une sécurité au niveau utilisateur afin de protéger les données dans Access 2003.|  
|[Comprendre le rôle des fichiers d'informations des groupes de travail dans la sécurité d'Access](http://support.microsoft.com/kb/305542)|Explique le rôle et la relation du fichier d'informations de groupe de travail dans la sécurité Access 2003.|  
|[Questions les plus fréquentes sur la sécurité de Microsoft Access pour les versions 2.0 à 2000 de Microsoft Access](http://go.microsoft.com/fwlink/?LinkId=47698)|Version téléchargeable du Forum aux questions sur la sécurité de Microsoft Access.|  
|[Résolution des problèmes de sécurité et de protection](http://go.microsoft.com/fwlink/?LinkId=47703)|Présente des solutions aux problèmes courants de sécurité dans Excel 2003.|  
...
|Ressource|Description|  
|---------------|-----------------|  
|[COM\+ Role\-Based Security and the .NET Framework](http://msdn.microsoft.com/fr-fr/02ab22ef-e5e2-4d29-b33a-6e03d94c4981)|Explique comment intégrer du code managé à des services de sécurité COM\+.|  
...
|Ressource|Description|  
|---------------|-----------------|  
|[Interoperating with Unmanaged Code](../../../../docs/framework/interop/index.md)|Contient des rubriques qui décrivent comment exposer les composants COM au .NET Framework et comment exposer les composants .NET Framework à COM.|  
|[Advanced COM Interoperability](http://msdn.microsoft.com/fr-fr/3ada36e5-2390-4d70-b490-6ad8de92f2fb)|Contient des sujets avancés tels que les assemblys PIA \(Primary Interop Assembly\), les threads et le marshaling personnalisé.|  
