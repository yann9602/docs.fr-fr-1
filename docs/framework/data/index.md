---
title: "Donn&#233;es et mod&#233;lisation dans le .NET Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework, accès aux données"
  - "données (.NET Framework), accéder"
  - "accès aux données (.NET Framework), à propos de l'accès aux données .NET Framework"
...
---
# Donn&#233;es et mod&#233;lisation dans le .NET Framework
...
## Dans cette section  
 ...
 [LINQ Portal](http://msdn.microsoft.com/fr-fr/6eb15c76-4ee6-4146-981e-b3429a945e6f)  
...
## Rubriques connexes  
 [Technologies de modélisation Microsoft SQL Server](http://go.microsoft.com/fwlink/?LinkId=193039)  
