...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Montre comment créer et accéder à un simple [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]-en fonction de service qui expose un flux basé sur la base de données Northwind.  
 ...
 Fournit des liens vers [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] et [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] ressources.  
