---
title: "Mat&#233;rialisation d&#39;objets (WCF Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
2.  La bibliothèque cliente lit la valeur URI de l'élément `id` de `entry`, qui est la valeur d'identité de l'entité.  À moins qu'une valeur <xref:System.Data.Services.Client.DataServiceContext.MergeOption%2A> de <xref:System.Data.Services.Client.MergeOption> soit utilisée, la valeur d'identité est utilisée pour suivre l'objet dans <xref:System.Data.Services.Client.DataServiceContext>.  La valeur d'identité est également utilisée pour garantir que seule une instance d'entité est créée, même lorsqu'une entité est retournée plusieurs fois dans la réponse à la requête.  
...
5.  La bibliothèque cliente joint l'objet à <xref:System.Data.Services.Client.DataServiceContext>.  L'objet n'est pas joint quand <xref:System.Data.Services.Client.MergeOption> est <xref:System.Data.Services.Client.MergeOption>.  
