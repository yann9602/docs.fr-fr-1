...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)][!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] stratégie de sécurité, consultez [securityPolicy, élément (schéma des paramètres ASP.NET)](http://msdn.microsoft.com/library/469d8d22-d263-46bb-8400-40d8d027faba).  
...
```  
 ...
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][add, élément d’assemblies pour compilation (schéma des paramètres ASP.NET)](http://msdn.microsoft.com/library/602197e8-108d-4249-b752-ba2a318f75e4).  
...
## <a name="see-also"></a>Voir aussi  
 ...
 [securityPolicy, élément (schéma des paramètres ASP.NET)](http://msdn.microsoft.com/library/469d8d22-d263-46bb-8400-40d8d027faba)  
