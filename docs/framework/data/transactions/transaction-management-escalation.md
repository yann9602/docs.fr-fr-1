---
title: "Remont&#233;e de la gestion des transactions  | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|----------------------|---------------|  
|<xref:System.InvalidOperationException>|Tentative de remontée d'une transaction avec un niveau d'isolation égal à <xref:System.Transactions.IsolationLevel>.|  
