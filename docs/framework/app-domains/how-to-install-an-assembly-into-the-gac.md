---
title: "Comment&#160;: installer un assembly dans le Global Assembly Cache | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "Global Assembly Cache, installer les assemblys"
...
> [!IMPORTANT]
>  Seuls les assemblys avec noms forts peuvent être installés dans le GAC.  Pour plus d'informations sur la création d'un assembly avec nom fort, consultez [Comment : signer un assembly avec un nom fort](../../../docs/framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md).  
  
-   En utilisant [Windows Installer](http://msdn.microsoft.com/library/windows/desktop/cc185688.aspx).  
...
-   En utilisant l'[outil Global Assembly Cache Tool \(Gacutil.exe\)](../../../docs/framework/tools/gacutil-exe-gac-tool.md).  
...
6.  Pour chaque projet de la solution qui contient un assembly à installer dans le Global Assembly Cache :  
    ...
    3.  Dans le volet **Fichiers de l'ordinateur source**, choisissez **Sortie principale de** *\<nom\_projet\>*.  
