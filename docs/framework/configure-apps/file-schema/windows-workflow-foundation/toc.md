# [Schéma de configuration de Windows Workflow Foundation](index.md)
...
######## [<states>](states.md)
######### [<state>](state.md)
###### [Utilisation de l’annotation dans les requêtes](using-annotation-in-queries.md)
## [Référence managée supplémentaire](additional-managed-reference.md)
