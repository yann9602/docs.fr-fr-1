...
Cette rubrique fournit des informations destinées aux développeurs qui souhaitent installer le [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, le [!INCLUDE[net_v46](../../../includes/net-v46-md.md)] 4.6.1, 4.6.2 ou le .NET Framework 4.7 avec leurs applications.
...
> [!NOTE]
> L’expression « le [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] et ses mises en production intermédiaires » fait référence au [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 et 4.7.

- Le [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2 et 4.7 sont des mises à jour sur place du [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], ce qui signifie qu’elles utilisent la même version du runtime. Cependant, les versions des assemblys sont mises à jour et incluent de nouveaux types et membres.

- [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] et ses versions intermédiaires sont générés de façon incrémentielle sur [!INCLUDE[net_v40_long](../../../includes/net-v40-long-md.md)]. Quand vous installez le [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 ou 4.7 sur un système où le [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] est installé, les assemblys de version 4 sont remplacés par les versions plus récentes.
...
```
 ...
 Pour déterminer si la mise en production finale d’un module linguistique est installée pour le [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 ou 4.7, vérifiez la valeur DWORD de la clé RELEASE décrite dans la section précédente, [Détection du .NET Framework](#detect_net).
...
## <a name="uninstalling-the-net-framework"></a>Désinstallation du .NET Framework
 À compter du [!INCLUDE[win8](../../../includes/win8-md.md)], vous pouvez désinstaller le [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 ou 4.7 en utilisant l’option **Activer ou désactiver des fonctionnalités Windows** du Panneau de configuration. Dans les versions antérieures de Windows, vous pouvez désinstaller le [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2 ou 4.7 à l’aide de l’option **Ajout/Suppression de programmes** du Panneau de configuration.

> [!IMPORTANT]
> Pour Windows 7 et les systèmes d’exploitation antérieurs, la désinstallation du [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2 ou 4.7 ne restaure pas les fichiers du [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], et la désinstallation du [!INCLUDE[net_v45](../../../includes/net-v45-md.md)] ne restaure pas les fichiers du [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)]. Si vous souhaitez revenir à la version antérieure, vous devez la réinstaller et effectuer toutes les mises à jour correspondantes.
