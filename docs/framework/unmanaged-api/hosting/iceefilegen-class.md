...
---
# <a name="iceefilegen-class"></a><span data-ttu-id="5cd99-102">ICeeFileGen, classe</span><span class="sxs-lookup"><span data-stu-id="5cd99-102">ICeeFileGen Class</span></span>
<span data-ttu-id="5cd99-103">Fournit des fonctionnalités pour la création d’un fichier exécutable portable natif (PE).</span><span class="sxs-lookup"><span data-stu-id="5cd99-103">Provides functionality for creating a native portable executable (PE) file.</span></span> <span data-ttu-id="5cd99-104">L’interface sera généralement être utilisée par les compilateurs pour générer leur fichier exécutable de sortie compilé.</span><span class="sxs-lookup"><span data-stu-id="5cd99-104">The interface will typically be used by compilers to generate their compiled output executable.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="5cd99-105">`ICeeFileGen`prend en charge l’infrastructure .NET Framework et n’est pas destinée à être utilisée directement depuis votre code.</span><span class="sxs-lookup"><span data-stu-id="5cd99-105">`ICeeFileGen` supports the .NET Framework infrastructure and is not intended to be used directly from your code.</span></span>  
  
 <span data-ttu-id="5cd99-106">Cette interface a été déconseillée et sera supprimée dans une version ultérieure.</span><span class="sxs-lookup"><span data-stu-id="5cd99-106">This interface has been deprecated and will be removed in a future release.</span></span>  
  
## <a name="syntax"></a><span data-ttu-id="5cd99-107">Syntaxe</span><span class="sxs-lookup"><span data-stu-id="5cd99-107">Syntax</span></span>  
...
## <a name="requirements"></a><span data-ttu-id="5cd99-108">Spécifications</span><span class="sxs-lookup"><span data-stu-id="5cd99-108">Requirements</span></span>  
 <span data-ttu-id="5cd99-109">**Plateformes :** consultez [requise](../../../../docs/framework/get-started/system-requirements.md).</span><span class="sxs-lookup"><span data-stu-id="5cd99-109">**Platforms:** See [System Requirements](../../../../docs/framework/get-started/system-requirements.md).</span></span>  
  
 <span data-ttu-id="5cd99-110">**En-tête :** ICeeFileGen.h</span><span class="sxs-lookup"><span data-stu-id="5cd99-110">**Header:** ICeeFileGen.h</span></span>  
  
 <span data-ttu-id="5cd99-111">**Version du .NET framework :** 1.0</span><span class="sxs-lookup"><span data-stu-id="5cd99-111">**.NET Framework Version:** 1.0</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="5cd99-112">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="5cd99-112">See Also</span></span>  
 [<span data-ttu-id="5cd99-113">Interfaces d’hébergement</span><span class="sxs-lookup"><span data-stu-id="5cd99-113">Hosting Interfaces</span></span>](../../../../docs/framework/unmanaged-api/hosting/hosting-interfaces.md)
