...
#### <a name="parameters"></a>Paramètres  
 `phPort`  
 [out] Pointeur vers un handle vers le port de terminaison d’e/s nouvellement créé, ou 0 (zéro) si le port n’a pas pu être créé.  
