...
### [Fonctions statiques globales d’hébergement .NET Framework 4](net-framework-4-hosting-global-static-functions.md)
#### [CLRCreateInstance, fonction](clrcreateinstance-function.md)
### [Fonctions d’hébergement CLR dépréciées](deprecated-clr-hosting-functions.md)
...
### [Coclasses et interfaces d’hébergement CLR dépréciées](deprecated-clr-hosting-interfaces-and-coclasses.md)
...
### [Interfaces d’hébergement CLR ajoutées dans .NET Framework 4 et 4.5](clr-hosting-interfaces-added-in-the-net-framework-4-and-4-5.md)
