...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](../../../../docs/framework/unmanaged-api/debugging/icordebugtypeenum-next-method.md)|Obtient le nombre spécifié de `ICorDebugType` les instances de l’énumération, en démarrant à la position actuelle.|  
