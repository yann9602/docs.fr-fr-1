...
## <a name="language-type-constants"></a>Constantes de Type de langage  
 Le tableau suivant affiche des constantes de type, qui représentent les GUID qui identifient les langages de programmation langage.  
  
|Symbole|Description|  
|------------|-----------------|  
|CorSym_LanguageType_C|Indique le langage C.|  
|CorSym_LanguageType_CPlusPlus|Indique le langage C++.|  
|CorSym_LanguageType_CSharp|Indique le langage c#.|  
|CorSym_LanguageType_Basic|Indique la langue de base.|  
|CorSym_LanguageType_Java|Indique le langage Java.|  
|CorSym_LanguageType_Cobol|Indique la langue COBOL.|  
|CorSym_LanguageType_Pascal|Indique la langue de la casse Pascal.|  
...
|CorSym_LanguageType_SMC|Indique la langue SMC.|  
...
|CorSym_DocumentType_MC|Indique un document non textuelles.|  
