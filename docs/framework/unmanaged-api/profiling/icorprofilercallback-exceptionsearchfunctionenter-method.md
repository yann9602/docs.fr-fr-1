...
Notifie le profileur que la phase de recherche de la gestion des exceptions a commencé à rechercher une fonction afin de trouver un gestionnaire pour l’exception actuelle.  
