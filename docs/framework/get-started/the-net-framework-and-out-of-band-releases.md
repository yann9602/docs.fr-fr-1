---
title: "Versions finales hors plage de .NET Framework | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
3.  Une fois le téléchargement terminé, redémarrez Visual Studio.  
 ...
 Pour obtenir des instructions d'installation détaillées, voir [Installing NuGet](http://docs.nuget.org/docs/start-here/installing-nuget) sur le site web NuGet Docs.  Pour plus d'informations sur NuGet, voir la [documentation de NuGet](http://docs.nuget.org/).  
  
## Utilisation d'un package OOB NuGet  
...
## Types de versions OOB  
 ...
 Si vous voulez être averti de la publication des packages stables, abonnez\-vous au [flux .NET Framework](https://nuget.org/api/v2/curated-feeds/dotnetframework/Packages/).  
