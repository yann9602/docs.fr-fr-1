...
---
# <a name="getting-started-with-the-net-framework"></a>Mise en route du .NET Framework
...
## <a name="see-also"></a>Voir aussi  
 [.NET Framework 4.6 et 4.5](../../../docs/framework/index.md)   
