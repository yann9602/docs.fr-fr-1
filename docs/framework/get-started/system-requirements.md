...
---
# <a name="net-framework-system-requirements"></a>Configuration requise du .NET Framework
...
- .NET Framework 4.7 est préinstallé sur Windows 10 Creators Update. Il n’est pas disponible pour l’installation sur d’autres systèmes d’exploitation Windows.
