...
helpviewer_keywords: 
  ...
  - "empiler des éléments (WPF)"
  - "StackPanel (contrôle WPF)"
...
---
# StackPanel
L'élément <xref:System.Windows.Controls.StackPanel> est utilisé pour empiler les éléments enfants verticalement ou horizontalement.  
