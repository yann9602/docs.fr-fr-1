...
|Vous débutez avec .NET ?|[Vue d’ensemble du .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Éléments de base des applications .NET Framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Bien démarrer avec Visual Basic et Visual C#](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|  
