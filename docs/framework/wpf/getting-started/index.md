...
|Vous débutez avec .NET ?|[Vue d’ensemble du .NET Framework](https://msdn.microsoft.com/en-us/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Éléments de base des applications .NET Framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Mises en route de Visual Basic et Visual C#](https://msdn.microsoft.com/en-us/library/dd492171\(v=vs.140\).aspx)|  
