...
---
# Images
[!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] intègre une prise en charge pour plusieurs formats d'images, un rendu d'image haute fidélité et une extensibilité codec [](GTMT).  
