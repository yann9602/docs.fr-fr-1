...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="54ff3-102">Comment : convertir un BitmapSource au format de pixel indexé</span><span class="sxs-lookup"><span data-stu-id="54ff3-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="54ff3-103">Cet exemple montre comment convertir un <xref:System.Windows.Media.Imaging.BitmapSource> dans un format de pixel indexé.</span><span class="sxs-lookup"><span data-stu-id="54ff3-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="54ff3-104">Exemple</span><span class="sxs-lookup"><span data-stu-id="54ff3-104">Example</span></span>  
