...
---
# <a name="how-to-animate-the-size-of-an-arcsegment"></a>Comment : animer la taille d'un ArcSegment
Cet exemple montre comment animer la <xref:System.Windows.Media.ArcSegment.Size%2A> propriété d’un <xref:System.Windows.Media.ArcSegment>.  
  
## <a name="example"></a>Exemple  
 L’exemple suivant crée un <xref:System.Windows.Media.ArcSegment> qui anime sa <xref:System.Windows.Media.ArcSegment.Size%2A> lors de son chargement dans l’écran.  
 ...
 Pour les géométries supplémentaires et des exemples d’animation, consultez le [géométries, exemple](http://go.microsoft.com/fwlink/?LinkID=159989).  
