---
title: "Vue d&#39;ensemble de l&#39;impression | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
helpviewer_keywords: 
  ...
  - "imprimantes, XPSDrv"
  - "imprimer"
  - "PrintQueue (classe) PrintServer (classe)"
  - "PrintTicket (classe)"
  - "XML Paper Specification (XPS) (format de fichier)"
...
-   [À propos de XPS](#introduction_to_XPS)  
  
-   [Chemin d'impression XPS](#XPS_print_path_intro)  
  
-   [Chemin d'impression GDI](#GDI_Print_Path_intro)  
  
-   [Modèle de pilote XPSDrv](#XPS_Driver_Model_intro)  
  
-   [Rubriques connexes](#seeAlso_Toggle)  
...
-   format [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] conforme aux normes du secteur.  
 ...
 [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] a été conçu dans l'optique d'offrir une extensibilité.  Grâce à l'infrastructure d'extensibilité, il est possible d'ajouter des fonctionnalités et des fonctions à [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] de façon modulaire.  Les fonctionnalités d'extensibilité sont les suivantes :  
...
-   Pour obtenir des documents de référence supplémentaires sur le chemin d'impression [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] et les différentes options de conversion [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)], consultez [Échappement d'imprimante Microsoft XPS Document Converter](_win32_MXDC_ESCAPE) et « XPSDrv » dans [Kit de développement de pilotes Windows](http://msdn.microsoft.com/library/default.asp?url=/%20library/dnanchor/html/DeviceDriver.asp).  
...
## Voir aussi  
 ...
 [Rubriques Comment](../../../../docs/framework/wpf/advanced/printing-how-to-topics.md)   
 ...
 [Échappement d'imprimante Microsoft XPS Document Converter](_win32_MXDC_ESCAPE)