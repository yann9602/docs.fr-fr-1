...
### [Cycle de vie des applications Docker en conteneur avec la plateforme et les outils Microsoft](standard/containerized-lifecycle-architecture/)
...
### [Générer une bibliothèque de classes avec C# et .NET Core dans Visual Studio 2017](core/tutorials/library-with-visual-studio.md)
...
## [Prérequis pour macOS](core/macos-prerequisites.md)
## [Prérequis pour Linux](core/linux-prerequisites.md)
...
### [Créer un modèle personnalisé pour dotnet new](core/tutorials/create-custom-template.md)
...
### [Magasin de packages de runtime](core/deploying/runtime-store.md)
## [Docker](core/docker/index.md)
### [Introduction à .NET et à Docker](core/docker/intro-net-docker.md)
### [Découvrir les concepts de base de Docker avec .NET Core](core/docker/docker-basics-dotnet-core.md)
...
### [Tests unitaires F# avec xUnit](core/testing/unit-testing-fsharp-with-dotnet-test.md)
### [Tests unitaires F# avec NUnit](core/testing/unit-testing-fsharp-with-nunit.md)
### [Tests unitaires F# avec MSTest](core/testing/unit-testing-fsharp-with-mstest.md)
### [Tests unitaires VB avec xUnit](core/testing/unit-testing-visual-basic-with-dotnet-test.md)
### [Tests unitaires VB avec NUnit](core/testing/unit-testing-visual-basic-with-nunit.md)
### [Tests unitaires VB avec MSTest](core/testing/unit-testing-visual-basic-with-mstest.md)
...
### [Modèles personnalisés](core/tools/custom-templates.md)
...
### [Utilisation du pack de compatibilité Windows](core/porting/windows-compat-pack.md)
...
## [Démarrages rapides](csharp/quick-starts/)
...
### [Nouveautés de C# 7.2](csharp/whats-new/csharp-7-2.md)
### [Nouveautés de C# 7.1](csharp/whats-new/csharp-7-1.md)
### [Nouveautés de C# 7](csharp/whats-new/csharp-7.md)
### [Nouveautés de C# 6](csharp/whats-new/csharp-6.md)
### [Historique des versions de C#](csharp/whats-new/csharp-version-history.md)
### [Relations entre le langage et le framework](csharp/whats-new/relationships-between-language-and-library.md)
<!-- End What's New -->
...
### [Éléments ignorés](csharp/discards.md)
