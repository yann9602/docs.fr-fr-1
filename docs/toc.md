...
## [Outils .NET Core RC4](core/preview3/tools/index.md)
### [Vue d’ensemble des modifications de l’interface de ligne de commande](core/preview3/tools/layering.md)
### [Gestion des dépendances](core/preview3/tools/dependencies.md)
### [Déploiement d’applications](core/preview3/deploying/index.md)
### [Ajouts au format csproj](core/preview3/tools/csproj.md)
### [Données de télémétrie](core/preview3/tools/telemetry.md)
### [Modèle d’extensibilité](core/preview3/tools/extensibility.md)
### [Intégration continue](core/preview3/tools/using-ci-with-cli.md)
