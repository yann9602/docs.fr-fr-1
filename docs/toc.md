...
### [Tests unitaires F# avec dotnet-test et xUnit](core/testing/unit-testing-fsharp-with-dotnet-test.md)
### [Tests unitaires F# avec dotnet-test et MSTest](core/testing/unit-testing-fsharp-with-mstest.md)
...
## [Guides de démarrage rapide](csharp/quick-starts/)
