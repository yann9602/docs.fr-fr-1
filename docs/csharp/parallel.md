...
description: "Programmation parallèle"
...
# <a name="-parallel-programming"></a>🔧 Programmation parallèle

> **Remarque**
> 
> Cette rubrique n’a pas encore été rédigée ! 
>
> Votre aide pour en définir le cadre et l’approche est la bienvenue. Vous pouvez suivre la progression de ce [problème](https://github.com/dotnet/docs/issues/491) et y apporter vos commentaires dans GitHub.
> 
