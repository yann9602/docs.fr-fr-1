...
La classe de base ou l’interface 'classe' dans l’assembly 'assembly' référencé par le type 'type' n’a pas pu être résolue  
 ...
 Pour plus d’informations, consultez [boîte de dialogue Ajouter une référence](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) et [/reference (Options du compilateur c#)](../../csharp/language-reference/compiler-options/reference-compiler-option.md).  
...
## <a name="see-also"></a>Voir aussi  
 [Ajouter une référence de boîte de dialogue](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7)  
