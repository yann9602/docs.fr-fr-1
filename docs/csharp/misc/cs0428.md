...
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="b3364-102">Erreur du compilateur CS0428</span><span class="sxs-lookup"><span data-stu-id="b3364-102">Compiler Error CS0428</span></span>
<span data-ttu-id="b3364-103">Impossible de convertir le groupe de méthodes 'Identifier' en type non-délégué 'type'.</span><span class="sxs-lookup"><span data-stu-id="b3364-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="b3364-104">Voulez-vous appeler la méthode ?</span><span class="sxs-lookup"><span data-stu-id="b3364-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="b3364-105">Cette erreur se produit lors de la conversion d’un groupe de méthodes en un type non délégué, ou de la tentative d’appel d’une méthode sans utiliser de parenthèses.</span><span class="sxs-lookup"><span data-stu-id="b3364-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="b3364-106">Exemple</span><span class="sxs-lookup"><span data-stu-id="b3364-106">Example</span></span>  
 <span data-ttu-id="b3364-107">L’exemple suivant génère l’erreur CS0428 :</span><span class="sxs-lookup"><span data-stu-id="b3364-107">The following sample generates CS0428:</span></span>  
