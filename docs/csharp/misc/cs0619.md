...
'membre' est obsolète : 'texte'  
 ...
 Un membre de classe a été marqué avec l’attribut [Obsolete](http://msdn.microsoft.com/en-us/05e99cd0-bda6-4f79-a890-1ca093b4b488) . Une erreur sera donc générée quand le membre de classe sera référencé.  
