...
Mémoire insuffisante  
 ...
 Cette erreur peut également se produire si les versions du [!INCLUDE[winsdklong](../../csharp/language-reference/compiler-options/includes/winsdklong_md.md)] et du compilateur C\# ne sont pas incompatibles, ou si un ou plusieurs fichiers prenant en charge le compilateur C\# sont endommagés. Réinstallez Visual Studio.