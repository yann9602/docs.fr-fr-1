...
## <a name="see-also"></a>Voir aussi  
 ...
 [Exemples Visual Studio 2008 c# (voir les fichiers exemples de requêtes LINQ et le programme XQuery)](http://code.msdn.microsoft.com/Visual-Studio-2008-C-d295cdba)  
