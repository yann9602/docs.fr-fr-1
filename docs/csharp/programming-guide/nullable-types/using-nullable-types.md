...
## <a name="examples-of-nullable-types"></a>Exemples de types Nullable  
 Tout type valeur peut être utilisé comme base d’un type Nullable. Exemple :  
...
## <a name="explicit-conversions"></a>Conversions explicites  
 Un type Nullable peut être casté en type normal explicitement par un cast ou à l’aide de la propriété `Value`. Exemple :  
...
## <a name="the--operator"></a>??, Opérateur  
 ...
 Cet opérateur peut également être utilisé avec plusieurs types Nullable. Exemple :  
