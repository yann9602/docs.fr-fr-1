...
1.  Démarrez [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)].  
...
1.  Dans l'**Explorateur de solutions**, double\-cliquez sur le fichier Module1.vb si vous utilisez [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] ou sur le fichier Program.cs si vous utilisez Visual C\#.  
...
1.  Dans [!INCLUDE[vsprvs](../../../csharp/includes/vsprvs-md.md)], dans le menu **Fichier**, pointez sur **Nouveau**, puis cliquez sur **Projet**.  
...
3.  Si vous utilisez [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], cliquez avec le bouton droit sur le projet DynamicIronPythonSample, puis cliquez sur **Propriétés**.  Cliquez sur l'onglet **Références**.  Cliquez sur le bouton **Ajouter**.  Si vous utilisez Visual C\#, dans l'**Explorateur de solutions**, cliquez avec le bouton droit sur le dossier **Références**, puis cliquez sur **Ajouter une référence**.  
...
5.  Si vous utilisez [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)], modifiez le fichier Module1.vb.  Si vous utilisez Visual C\#, modifiez le fichier Program.cs.  
