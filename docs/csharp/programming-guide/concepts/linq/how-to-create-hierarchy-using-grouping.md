---
title: "Guide pratique pour créer une hiérarchie à l’aide de regroupements (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-create-hierarchy-using-grouping-c"></a>Guide pratique pour créer une hiérarchie à l’aide de regroupements (C#)
