...
## <a name="object-relational-designer"></a>Object Relational Designer  
 L’outil Concepteur Objet Relationnel est un outil de conception visuelle que vous pouvez utiliser dans les applications [LINQ to SQL](https://msdn.microsoft.com/library/bb386976) pour générer des classes en C# qui représentent les données relationnelles d’une base de données sous-jacente. Pour plus d’informations, consultez [Outils LINQ to SQL dans Visual Studio](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2).  
