---
title: "Guide pratique pour rechercher des nœuds frères (XPath-LINQ to XML) (C#) | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-find-sibling-nodes-xpath-linq-to-xml-c"></a>Guide pratique pour rechercher des nœuds frères (XPath-LINQ to XML) (C#)
