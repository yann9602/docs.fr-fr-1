---
title: Guide pratique pour filtrer sur un attribut (XPath-LINQ to XML) (C#) | Microsoft Docs
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
---
# <a name="how-to-filter-on-an-attribute-xpath-linq-to-xml-c"></a>Guide pratique pour filtrer sur un attribut (XPath-LINQ to XML) (C#)
