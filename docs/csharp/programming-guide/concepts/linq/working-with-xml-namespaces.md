...
|-----------|-----------------|  
|[Vue d'ensemble des espaces de noms (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/namespaces-overview-linq-to-xml.md)|Cette rubrique présente les espaces de noms, la classe <xref:System.Xml.Linq.XName> et la classe <xref:System.Xml.Linq.XNamespace>.|  
|[Guide pratique pour créer un document avec des espaces de noms (C#) (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/how-to-create-a-document-with-namespaces-linq-to-xml.md)|Montre comment créer des documents avec des espaces de noms.|  
|[Guide pratique pour contrôler les préfixes d’espaces de noms (C#) (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/how-to-control-namespace-prefixes-linq-to-xml.md)|Montre comment contrôler des préfixes d’espaces de noms en insérant des attributs d’espaces de noms dans l’arborescence XML.|  
