...
|-----------|-----------------|  
|[Exécution et évaluation différées dans LINQ to XML (C#)](../../../../csharp/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)|Décrit les concepts d'évaluation et d'exécution différées.|  
|[Exemple d’exécution différée (C#)](../../../../csharp/programming-guide/concepts/linq/deferred-execution-example.md)|Fournit un exemple d'exécution différée.|  
|[Exemple de chaînage de requêtes (C#)](../../../../csharp/programming-guide/concepts/linq/chaining-queries-example.md)|Montre comment fonctionne l'exécution différée lors du chaînage de requêtes.|  
