...
## <a name="see-also"></a>Voir aussi  
 ...
 [Paramètres et valeurs de retour pour les procédures multithreads (C#)](../../../../csharp/programming-guide/concepts/threading/parameters-and-return-values-for-multithreaded-procedures.md)  
