...
## Méthodes async  
 La fonctionnalité async vous permet d'appeler des méthodes asynchrones sans utiliser de rappels explicites ni fractionner manuellement votre code entre plusieurs méthodes ou expressions lambda. La fonctionnalité async a été introduite dans [!INCLUDE[vs_dev11_long](../../../csharp/includes/vs-dev11-long-md.md)].  
