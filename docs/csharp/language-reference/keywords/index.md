...
|[var](../../../csharp/language-reference/keywords/var.md)|[when (condition de filtre)](when.md)|[where (contrainte de type générique)](../../../csharp/language-reference/keywords/where-generic-type-constraint.md)|[where (clause de requête)](../../../csharp/language-reference/keywords/where-clause.md)|  
