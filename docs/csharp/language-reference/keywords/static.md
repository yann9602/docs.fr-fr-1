...
> [!NOTE]
>  L’utilisation du mot clé `static` est plus restreinte que dans C++. Pour comparer avec le mot clé C++, consultez [Classes de stockage (C++)](https://docs.microsoft.com/cpp/cpp/storage-classes-cpp#static).
