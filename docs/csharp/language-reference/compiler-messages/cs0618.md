...
'membre' est obsolète : 'texte'  
 ...
 Un membre de classe a été marqué avec l’attribut `Obsolete` de sorte qu’un avertissement est émis quand le membre de classe est référencé. Pour plus d’informations, consultez [Attributs courants](http://msdn.microsoft.com/library/2f48a7ec-9683-4899-a1d2-a08be8fc558b).  
