...
Le compilateur produit des fichiers exécutables (.exe), des bibliothèques de liens dynamiques (.dll) ou des modules de code (.netmodule).  
 ...
 Dans Visual Web Developer 2008, vous définissez les options du compilateur dans le fichier web.config. Pour plus d’informations, consultez [\<compilateur> Élément](https://msdn.microsoft.com/library/y9x69bzw).  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit les options de déploiement d’applications C#.  
