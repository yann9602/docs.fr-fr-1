---
title: Commande dotnet-migrate | Microsoft Docs
...
## <a name="name"></a>Nom 
dotnet-migrate : Migre un projet .NET Core Preview 2 vers un projet .NET Core RC4
