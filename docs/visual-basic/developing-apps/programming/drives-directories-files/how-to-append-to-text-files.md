---
title: "Guide pratique pour effectuer un ajout à des fichiers texte en Visual Basic | Microsoft Docs"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
Vous pouvez utiliser la méthode <xref:Microsoft.VisualBasic.FileIO.FileSystem.WriteAllText%2A> pour effectuer un ajout à un fichier texte en spécifiant que le paramètre `append` ait la valeur `True`.  
