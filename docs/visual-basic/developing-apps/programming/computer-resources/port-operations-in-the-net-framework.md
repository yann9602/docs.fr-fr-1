...
> [!NOTE]
>  Vous ne pouvez pas utiliser les classes [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort-md.md)] pour accéder directement à d'autres types de ports, tels que les ports parrallèles, les ports USB, etc.  
