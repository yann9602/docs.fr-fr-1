...
|`My.WebServices`|**Oui**|**Oui**|**Oui**|**Oui**|**Oui**|**Oui**|Non|Non|  
 ...
 <sup>1</sup> Version Windows Forms de `My.Application`.  Dérive de la version de la console \(voir Remarque 3\), ajoute une prise en charge pour interagir avec les fenêtres de l'application et fournit le modèle d'application [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
