...
Définit le compilateur afin qu'il cible le [!INCLUDE[Compact](../../../visual-basic/reference/command-line-compiler/includes/compact-md.md)].  
...
## Notes  
 L'option `/netcf` entraîne le compilateur [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] à cibler le [!INCLUDE[Compact](../../../visual-basic/reference/command-line-compiler/includes/compact-md.md)] plutôt que le [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort-md.md)] complet.  Les fonctionnalités de langage qui sont uniquement présentes dans le [!INCLUDE[dnprdnshort](../../../csharp/getting-started/includes/dnprdnshort-md.md)] complet sont désactivées.  
