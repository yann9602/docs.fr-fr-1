...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Montre comment charger des données XML dans un <xref:System.Xml.Linq.XDocument>ou <xref:System.Xml.Linq.XElement>objet à partir d’un fichier texte, une chaîne ou un flux.</xref:System.Xml.Linq.XElement> </xref:System.Xml.Linq.XDocument>  
 ...
 Montre comment transformer le contenu d’un <xref:System.Xml.Linq.XDocument>l’objet dans un nouveau document XML.</xref:System.Xml.Linq.XDocument>  
 ...
 Montre comment modifier des éléments, attributs et valeurs dans un littéral XML.  
