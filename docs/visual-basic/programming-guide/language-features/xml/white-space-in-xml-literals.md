...
-   Lorsqu'ils se trouvent dans une expression incorporée pour le contenu du texte d'un élément.  
 ...
 Dans le cas contraire, le compilateur traite les caractères d'espace blanc comme insignifiants et ne les inclut pas à l'objet [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)] du littéral.  
...
> [!NOTE]
>  Si l'attribut `xml:space` apparaît dans un littéral d'élément XML, le compilateur [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] inclut l'attribut dans l'objet <xref:System.Xml.Linq.XElement>, mais l'ajout de cet attribut ne change pas la manière dont le compilateur traite l'espace blanc.  
