...
A *propriété par défaut* est une propriété de classe ou structure que votre code peut accéder sans la spécifier. Lorsque le code appelant nomme une classe ou structure mais pas une propriété, et le contexte autorise l’accès à une propriété, [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] résout l’accès à cette classe ou de la propriété par défaut de la structure s’il en existe.  
