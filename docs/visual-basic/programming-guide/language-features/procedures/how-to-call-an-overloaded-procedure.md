...
3.  Vous n'avez pas à déterminer quelle version de la procédure appeler.  [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] passe le contrôle à la version qui correspond à votre liste d'arguments.  
