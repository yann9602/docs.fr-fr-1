...
Une procédure *récursive* est une procédure qui s'appelle elle\-même.  En général, ce n'est pas le moyen le plus efficace d'écrire du code [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
