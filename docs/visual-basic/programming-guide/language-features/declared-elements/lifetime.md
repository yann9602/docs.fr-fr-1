...
## Fin de la durée de vie  
 Lorsqu'une procédure se termine, les valeurs de ses variables locales ne sont pas conservées et [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] libère leur mémoire.  La prochaine fois que vous appelez la procédure, toutes ses variables locales sont recréées et réinitialisées.  
