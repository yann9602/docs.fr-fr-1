...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Explique les conversions classées par si le type de destination peut stocker les données.  
  
 [Conversions implicites et explicites](../../../../visual-basic/programming-guide/language-features/data-types/implicit-and-explicit-conversions.md)  
 Traite des conversions classifiées par si [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] effectue automatiquement.  
 ...
 Décrit la conversion entre des chaînes et numérique, `Boolean`, ou les valeurs de date/heure.  
 ...
 Montre comment convertir une `Object` variable en un autre type de données.  
  
 [Conversions de tableau](../../../../visual-basic/programming-guide/language-features/data-types/array-conversions.md)  
 Vous guide dans le processus de conversion entre les tableaux de types de données différents.  
...
## <a name="related-sections"></a>Rubriques connexes  
 ...
 Présente des problèmes courants qui peuvent se produire lorsque vous travaillez avec des types de données.
