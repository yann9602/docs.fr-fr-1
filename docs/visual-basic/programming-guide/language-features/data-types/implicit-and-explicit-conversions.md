...
Une *conversion implicite* ne requiert pas de syntaxe particulière dans le code source.  Dans l'exemple suivant, [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] convertit implicitement la valeur de `k` en une valeur à virgule flottante simple précision avant de l'assigner à `q`.  
