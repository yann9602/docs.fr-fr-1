...
`Me`, `My`, `MyBase` et `MyClass` en [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] ont des noms semblables, mais des fonctions différentes.  Cette rubrique décrit chacune de ces entités de façon à les distinguer.  
