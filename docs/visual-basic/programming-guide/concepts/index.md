---
title: Concepts de programmation (Visual Basic) | Microsoft Docs
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
|[Covariance et contravariance (Visual Basic)](../../../visual-basic/programming-guide/concepts/covariance-contravariance/covariance-and-contravariance.md)|Montre comment activer la conversion implicite de paramètres de type générique dans les interfaces et les délégués.|  
