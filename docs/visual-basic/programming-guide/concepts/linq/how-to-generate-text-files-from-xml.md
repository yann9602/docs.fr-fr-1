...
## <a name="example"></a>Exemple  
 Le [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] version utilise des procédures de code pour agréger la collection de chaînes en une seule chaîne.  
