...
Les documents WordprocessingML plus complexes possèdent des paragraphes qui sont mis en forme à l'aide de styles.  
 ...
 Pour accéder à des packages, il est important d’utiliser les relations entre les parties plutôt qu’un chemin d’accès arbitraire. Ce problème est abordée dans la manipulation de contenu dans un didacticiel WordprocessingML Document, mais les exemples de programmes qui sont inclus dans ce didacticiel illustrent l’approche correcte.  
  
## <a name="a-document-that-uses-styles"></a>Un document qui utilise des styles  
 L’exemple WordML présenté dans le [forme des Documents WordprocessingML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/shape-of-wordprocessingml-documents.md) rubrique est très simple. Le documents suivant est plus complexe : il possède des paragraphes qui sont mis en forme à l'aide de styles. Le moyen le plus simple pour afficher le code XML qui compose un document Office Open XML consiste à exécuter la [exemple que sorties Office Open XML Document Parts (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md).  
