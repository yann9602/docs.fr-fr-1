...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Instructions pas à pas pour créer un projet LINQ Visual Basic, ajout d’une source de données simple et effectuer des opérations de requête de base.  
...
## <a name="related-sections"></a>Rubriques connexes  
 ...
 Explique les LINQ à la technologie SQL et fournit des liens vers des rubriques qui vous aident à utilisent LINQ to SQL.  
 ...
 Décrit les outils qui sont disponibles dans l’environnement Visual Studio pour concevoir, coder et déboguer les applications prenant en charge LINQ.  
  
 [LINQ to Objects (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/linq-to-objects.md)  
 Inclut une sélection de rubriques de procédures relatives à l’aide de LINQ avec les collections en mémoire.  
 ...
 Fournit des liens vers les rubriques relatives à l’aide de LINQ en c#.
