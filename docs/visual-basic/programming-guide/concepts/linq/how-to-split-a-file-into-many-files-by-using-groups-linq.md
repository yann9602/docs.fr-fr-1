...
2.  Copiez ces noms dans un fichier texte nommé names2.txt et enregistrez le fichier dans votre dossier de projet : Notez que les deux fichiers ont certains noms en commun.  
