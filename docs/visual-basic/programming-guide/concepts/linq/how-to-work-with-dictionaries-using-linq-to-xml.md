...
## <a name="example"></a>Exemple  
 Cet exemple utilise des littéraux XML et une requête dans une expression incorporée. La requête projette de nouveaux <xref:System.Xml.Linq.XElement> objets, puis devenir le nouveau contenu pour le `Root` <xref:System.Xml.Linq.XElement> objet.  
