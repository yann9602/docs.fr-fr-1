...
## Notes  
 ...
 Le compilateur [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] convertit les propriétés d'axes enfants en appels à la méthode <xref:System.Xml.Linq.XContainer.Elements%2A>.  
