...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]mots clés de langage et les membres de la bibliothèque Runtime sont organisés selon leur fonction et utilisent.  
...
|Déterminer la longueur d’une chaîne.|<xref:Microsoft.VisualBasic.Strings.Len%2A>|  
...
|Retourne un tableau de chaînes basé sur le filtre.|<xref:Microsoft.VisualBasic.Strings.Filter%2A>|  
