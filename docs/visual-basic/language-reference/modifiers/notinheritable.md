 ...
 **Autres conditions**. Une classe ne peut pas être héritée est parfois appelée un *sealed* classe.  
  
 Le `NotInheritable` modificateur peut être utilisé dans ce contexte :  
