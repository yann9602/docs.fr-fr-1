...
[!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]Vous pouvez ainsi créer [!INCLUDE[vbteclinqext](../../../csharp/getting-started/includes/vbteclinqext_md.md)] expressions dans votre code.  
...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit le `Distinct` clause, qui restreint les valeurs de la variable de portée actuelle pour éliminer les doublons dans les résultats de la requête.  
 ...
 Décrit le `Let` clause, qui calcule une valeur et l’assigne à une variable dans la requête.  
  
 [Order By (clause)](../../../visual-basic/language-reference/queries/order-by-clause.md)  
 Décrit le `Order By` clause qui spécifie l’ordre de tri pour les colonnes dans une requête.  
  
 [Select (clause)](../../../visual-basic/language-reference/queries/select-clause.md)  
 Décrit le `Select` clause qui déclare un jeu de variables de portée pour une requête.  
 ...
 Décrit la `Skip While` clause, qui ignore les éléments d’une collection tant qu’une condition spécifiée est `true` , puis retourne les éléments restants.  
 ...
 Décrit la `Take While` clause qui inclut les éléments d’une collection tant qu’une condition spécifiée est `true` et ignore les éléments restants.  
