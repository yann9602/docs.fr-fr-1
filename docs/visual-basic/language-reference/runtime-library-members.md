---
title: "Membres de la bibliothèque runtime Visual Basic"
ms.date: 07/20/2015
ms.prod: .net
...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="8866c-102">Membres de la bibliothèque runtime Visual Basic</span><span class="sxs-lookup"><span data-stu-id="8866c-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="8866c-103">Le `Microsoft.VisualBasic` espace de noms contient les classes, les modules, les constantes et les énumérations qui constituent le [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] de la bibliothèque runtime.</span><span class="sxs-lookup"><span data-stu-id="8866c-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] runtime library.</span></span> <span data-ttu-id="8866c-104">Ces membres de bibliothèque fournissent les procédures, les propriétés et les valeurs de constante que vous pouvez utiliser dans votre code.</span><span class="sxs-lookup"><span data-stu-id="8866c-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="8866c-105">Chaque module et la classe représentent une catégorie particulière de fonctionnalité.</span><span class="sxs-lookup"><span data-stu-id="8866c-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="8866c-106">Classe Microsoft.VisualBasic.Collection</span><span class="sxs-lookup"><span data-stu-id="8866c-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="8866c-107">Classe Microsoft.VisualBasic.ComClassAttribute</span><span class="sxs-lookup"><span data-stu-id="8866c-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="8866c-108">Classe Microsoft.VisualBasic.ControlChars</span><span class="sxs-lookup"><span data-stu-id="8866c-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="8866c-109">Classe Microsoft.VisualBasic.Constants</span><span class="sxs-lookup"><span data-stu-id="8866c-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="8866c-110">Module de Microsoft.VisualBasic.Conversion</span><span class="sxs-lookup"><span data-stu-id="8866c-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="8866c-111">Module de Microsoft.VisualBasic.DateAndTime</span><span class="sxs-lookup"><span data-stu-id="8866c-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="8866c-112">Classe Microsoft.VisualBasic.ErrObject</span><span class="sxs-lookup"><span data-stu-id="8866c-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="8866c-113">Module de Microsoft.VisualBasic.FileSystem</span><span class="sxs-lookup"><span data-stu-id="8866c-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="8866c-114">Module de Microsoft.VisualBasic.Financial</span><span class="sxs-lookup"><span data-stu-id="8866c-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="8866c-115">Module de Microsoft.VisualBasic.Globals</span><span class="sxs-lookup"><span data-stu-id="8866c-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="8866c-116">Classe Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="8866c-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="8866c-117">Module de Microsoft.VisualBasic.Information</span><span class="sxs-lookup"><span data-stu-id="8866c-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="8866c-118">Module de Microsoft.VisualBasic.Interaction</span><span class="sxs-lookup"><span data-stu-id="8866c-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="8866c-119">Classe Microsoft.VisualBasic.MyGroupCollectionAttribute</span><span class="sxs-lookup"><span data-stu-id="8866c-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="8866c-120">Module de Microsoft.VisualBasic.Strings</span><span class="sxs-lookup"><span data-stu-id="8866c-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="8866c-121">Classe Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="8866c-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="8866c-122">Classe Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="8866c-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="8866c-123">Module de Microsoft.VisualBasic.VbMath</span><span class="sxs-lookup"><span data-stu-id="8866c-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="8866c-124">Constantes et énumérations Microsoft.VisualBasic</span><span class="sxs-lookup"><span data-stu-id="8866c-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="8866c-125">Le `Microsoft.VisualBasic` espace de noms fournit des constantes et énumérations dans le cadre de la [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] bibliothèque Runtime.</span><span class="sxs-lookup"><span data-stu-id="8866c-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] run-time library.</span></span> <span data-ttu-id="8866c-126">Vous pouvez utiliser ces valeurs constantes dans votre code.</span><span class="sxs-lookup"><span data-stu-id="8866c-126">You can use these constant values in your code.</span></span> <span data-ttu-id="8866c-127">Chaque énumération représente une catégorie particulière de fonctionnalité.</span><span class="sxs-lookup"><span data-stu-id="8866c-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="8866c-128">Pour plus d’informations, consultez [constantes et énumérations](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="8866c-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="8866c-129">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="8866c-129">See Also</span></span>  
 [<span data-ttu-id="8866c-130">Constantes et énumérations</span><span class="sxs-lookup"><span data-stu-id="8866c-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)  
 [<span data-ttu-id="8866c-131">Mots clés</span><span class="sxs-lookup"><span data-stu-id="8866c-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
