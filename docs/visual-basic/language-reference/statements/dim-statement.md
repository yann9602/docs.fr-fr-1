...
##  <a name="default"></a><span data-ttu-id="2deb4-220">Types de données par défaut et valeurs</span><span class="sxs-lookup"><span data-stu-id="2deb4-220">Default Data Types and Values</span></span>  
