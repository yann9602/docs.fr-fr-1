...
> [!NOTE]
>  Un littéral XML peut couvrir plusieurs lignes, sans devoir utiliser de caractères de continuation de ligne.  Cela vous permet de copier le contenu d'un document XML et de le coller directement dans un programme [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
  
 Le compilateur [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] convertit le littéral d'instruction de traitement XML en un appel au constructeur <xref:System.Xml.Linq.XProcessingInstruction.%23ctor%2A>.  
