...
Consultez l'une des catégories répertoriées ci\-dessous ou ouvrez cette partie de la table des matières de l'aide pour consulter une liste alphabétique des opérateurs [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)].  
