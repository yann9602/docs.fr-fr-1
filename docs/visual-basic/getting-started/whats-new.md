---
title: "Nouveautés dans Visual Basic | Microsoft Docs"
ms.date: 2015-07-20
ms.prod: .net
ms.technology:
...
---
# <a name="whats-new-for-visual-basic"></a>Nouveautés dans Visual Basic
...
## <a name="see-also"></a>Voir aussi  
 [Nouveautés dans Visual Studio 2017](https://docs.microsoft.com/en-us/visualstudio/ide/whats-new-in-visual-studio)
