...
##### [My.Settings, objet](my-settings-object.md)
...
##### [Accès d'un membre partagé via une instance ; l'expression qualifiante ne sera pas évaluée](access-of-shared-member-through-an-instance-qualifying-expression.md)
...
##### [Le type de la valeur facultative pour le paramètre facultatif <nom_paramètre> n’est pas conforme à CLS](type-of-optional-value-for-optional-parameter-is-not-cls-compliant.md)
