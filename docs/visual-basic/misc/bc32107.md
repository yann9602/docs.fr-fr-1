...
---
# <a name="39class39-constraint-and-a-specific-class-type-constraint-cannot-be-combined"></a>& #39 ; Classe & #39 ; la contrainte et une contrainte de type classe spécifique ne peut pas être combinés.
Une liste de contraintes comprend à la fois la contrainte [Class (Visual Basic)](http://msdn.microsoft.com/en-us/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) et le nom d’une classe définie.  
