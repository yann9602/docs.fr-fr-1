...
Une procédure est déclarée avec des paramètres ou un type de retour qui ne peuvent pas être représentés par [!INCLUDE[vsprvs](../../csharp/includes/vsprvs-md.md)].  
