...
---
# <a name="39handles39-in-modules-must-specify-a-39withevents39-variable-qualified-with-a-single-identifier"></a>' Handles' dans les modules doivent spécifier une variable 'WithEvents' qualifiée par un identificateur unique
