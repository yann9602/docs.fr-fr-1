...
Une expression utilisée pour un argument d’attribut est évaluée à un type de données différent de celui du paramètre d’attribut correspondant, et [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] n’autorise pas la conversion de type requise pour les arguments d’attributs.  
