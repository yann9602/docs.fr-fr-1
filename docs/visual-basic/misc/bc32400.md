...
Une initialisation de classe a échoué. L’une des causes possibles est une installation [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort-md.md)] endommagée.  
...
2.  Réinstallez le [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort-md.md)] et recompilez le programme.  
