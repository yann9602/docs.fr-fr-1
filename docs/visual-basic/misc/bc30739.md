...
---
# <a name="39raiseevent39-statements-are-not-valid-in-the-immediate-window"></a>Les instructions 'RaiseEvent' ne sont pas valides dans la fenêtre exécution
`RaiseEvent`instructions ne peuvent pas être utilisées dans les **immédiat** fenêtre.  
