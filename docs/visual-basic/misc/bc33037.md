...
Une procédure est déclarée avec un type de paramètre qui ne peut pas être reconverti en type d’argument appelant.  
 ...
 Si vous passez l’argument [ByRef](../../visual-basic/language-reference/modifiers/byref.md), [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] copie parfois la valeur de l’argument dans une variable locale de la procédure au lieu de passer une référence. Dans ce cas, quand la procédure est retournée, [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] doit recopier la valeur de la variable locale dans l’argument du code appelant.  
...
-   Si possible, utilisez un argument d’appel du même type que celui du paramètre de procédure, pour que [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] n’ait pas besoin d’effectuer de conversion.  
...
-   Si vous devez retourner une valeur dans l’argument d’appel, définissez l’opérateur de conversion inverse pour que [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] puisse reconvertir le type vers le type de l’argument d’appel.  
