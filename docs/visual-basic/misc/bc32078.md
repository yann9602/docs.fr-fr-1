...
Une propriété, une procédure ou un événement générique tente d’implémenter un membre semblable défini dans une interface, mais les listes de contraintes sur leurs paramètres de type diffèrent.  
 ...
 Pour plus d’informations sur l’implémentation d’une interface, consultez [NOT IN BUILD : Implements (mot clé) et Implements (instruction)](http://msdn.microsoft.com/en-us/b96560f7-6413-480f-a1e2-f80253bab5be).  
