...
Une liste de contraintes comprend à la fois la contrainte [Structure (Visual Basic)](http://msdn.microsoft.com/en-us/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) et le nom d’une classe définie.  
