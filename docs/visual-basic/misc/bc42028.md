...
-   [Static](../../visual-basic/language-reference/modifiers/static.md)  
 ...
 En outre, vous ne pouvez pas utiliser le [implémente](../../visual-basic/language-reference/statements/implements-clause.md) instruction ou le [l’instruction Inherits](../../visual-basic/language-reference/statements/inherits-statement.md) dans le bloc d’instructions du module.  
