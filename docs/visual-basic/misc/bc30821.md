...
'\<rsetstmt\>' n’est pas déclaré. Les instructions RSet ne sont plus prises en charge ; utilisez Microsoft.VisualBasic.RSet à la place.  
 ...
 Plusieurs fonctions qui étaient intrinsèques à [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] dans les versions précédentes ont été déplacées vers l’espace de noms <xref:Microsoft.VisualBasic?displayProperty=fullName>. Leurs fonctionnalités sont ainsi plus largement accessibles à tous les langages de programmation.  
