...
---
# <a name="operands-of-type-object-used-for-operator-39ltoperatorsymbolgt39-use-the-39isnot39-operator-to-test-object-identity"></a>Les opérandes de type Object utilisés pour l’opérateur '&lt;operatorsymbol&gt;' ; utilisez l’opérateur 'IsNot' pour tester l’identité de l’objet
Une expression utilise le `<>` opérateur avec un ou deux opérandes de le [Type de données Object](../../visual-basic/language-reference/data-types/object-data-type.md).  
