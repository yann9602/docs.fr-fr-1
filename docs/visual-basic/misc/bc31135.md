...
---
# <a name="specifiers-are-not-valid-on-39addhandler39-39removehandler39-and-39raiseevent39-methods"></a>Spécificateurs ne sont pas valides sur les méthodes 'AddHandler', 'RemoveHandler' et 'RaiseEvent'
...
## <a name="see-also"></a>Voir aussi  
 ...
 [NIB mots clés (Visual Basic)](http://msdn.microsoft.com/en-us/3a6fda51-6ade-4862-a407-1c305c3906ec)   
