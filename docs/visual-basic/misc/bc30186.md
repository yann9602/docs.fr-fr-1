...
---
# <a name="39using39-statements-are-not-valid-in-the-immediate-window"></a>Les instructions 'Using' ne sont pas valides dans la fenêtre exécution
`Using`instructions ne peuvent pas être utilisées dans le code source.  
