...
Une [Operator Statement](../../visual-basic/language-reference/statements/operator-statement.md) spécifie le mot clé [Implements](../../visual-basic/language-reference/statements/implements-clause.md) .  
 ...
 Seule une procédure `Function` ou `Sub` , une propriété ou un événement peut implémenter un membre d’interface. Pour plus d’informations sur l’implémentation, consultez [NOT IN BUILD : Exemples d’implémentation d’interface en Visual Basic](http://msdn.microsoft.com/en-us/50bf2a30-73b6-4126-a921-075fd6eec278).  
